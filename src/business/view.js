    ...
    render() {
        return <>
            ...
            <Modal show={this.state.show} size="lg" onHide={this.handleClose} animation={false}>
                <Modal.Header>
                    <Modal.Title>Business #123 Details</Modal.Title>
                ...
                <Modal.Body>
                    <Table striped bordered hover responsive="lg">
                        <tr>
                            ...
                            <th>Business Name:</th><td> Business1</td>
                        </tr>
                        <tr>
                            <th>Business Name(in Arabic):</th><td> Business1</td>
                            <th>Business Title:</th><td> Title here</td>

                        </tr>
                        <tr>
                            <th>Business Title(in Arabic):</th><td> Title in Arabic</td>
