...
const CapitalCreate = forwardRef((props, ref) => {
    ...
    function getCapital(id) {
        ...
        fetch('/v1/capital/' + id, requestOptions)
            .then(async response => {
    ...
    */
    ...
    const CapitalCategoryDetailsViewRef = useRef();
    function openCapitalCategoryDetailsView(id) {
        CapitalCategoryDetailsViewRef.current.open(id);
    }
    ...
    return (
        <>
            ...
            <Modal show={show} size="xl" onHide={handleClose} animation={false} backdrop="static" scrollable={true}>
                <Modal.Header>
                    <Modal.Title>
                        {formData.id ? "Update InvestedByUser Capital #" + formData.description : "Create New Capital Investment"}
                    </Modal.Title>
                ...
                <Modal.Body>
                    <form className="row g-3 needs-validation" onSubmit={handleCreate}>
                        ...
                        <div className="col-md-6">
                            <label className="form-label">Invested By User*</label>
