    ...
    render() {
        return <>
            ...
            <Modal show={this.state.show} scrollable={true} size="lg" onHide={this.handleClose} animation={false}>
                <Modal.Header>
                    <Modal.Title>Update Customer #123</Modal.Title>
                    ...
                    <form className="row g-3 needs-validation" >
                        <div className="col-md-6">
                            ...
                            <div className="input-group mb-3">
                                <input type="text" value="Customer 1" className="form-control" placeholder="Customer Name" aria-label="Select Business" aria-describedby="button-addon1" />
