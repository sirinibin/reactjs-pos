...
const CustomerDepositCreate = forwardRef((props, ref) => {
    ...
    const NAV_TABS = [
        ...
        { id: 'payments',    label: 'Payments',           icon: 'bi-cash-stack'  },
                        ...
                        <aside className="pw-sidebar">
                            <div className="pw-sidebar-header">
                                <div style={{ fontFamily: '"Hanken Grotesk", sans-serif', fontSize: '15px', fontWeight: 700, color: '#191c1e', marginBottom: '2px' }}>
                                    {formData.id ? 'Edit Receipt' : 'New Receipt'}
                                </div>
                                <div style={{ fontFamily: '"Inter", sans-serif', fontSize: '11px', color: '#434655' }}>Receipt Wizard</div>
                            </div>
                            {NAV_TABS.map((tab) => (
                                            ...
                                            {formData.type === "customer" && (
                                                <div className="row g-3 mt-1 align-items-end">
                                                    <div className="col-md-10">
                                                        ...
                                                        />
                                                        <Button hide={true.toString()} onClick={openCustomerCreateForm} className="btn btn-outline-secondary btn-primary btn-sm mt-1" type="button" id="button-addon1">
                                            ...
                                            {formData.type === "vendor" && (
                                                <div className="row g-3 mt-1 align-items-end">
                                                    <div className="col-md-10">
                                                        ...
                                                        />
                                                        <Button hide={true.toString()} onClick={openVendorCreateForm} className="btn btn-outline-secondary btn-primary btn-sm mt-1" type="button" id="button-addon1">
                                                            <i className="bi bi-plus-lg"></i> New
                                                        </Button>
