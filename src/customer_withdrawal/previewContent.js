                ...
                <div className="row" style={{ fontSize: "3.5mm" }}>
                    ...
                    <div className="col">
                        <ul className="list-unstyled text-end">
                            ...
                            {/* <!-- <li><hr /></li> --> */}
                            <li style={{ fontSize: "2.2mm" }}><span dir="rtl">س.ت / {props.model.store?.registration_number_in_arabic ? props.model.store.registration_number_in_arabic : (props.model.store?.registration_number ? convertToArabicNumber(props.model.store.registration_number) : "<STORE_CR_NO_ARABIC>")}</span></li>
                            <li style={{ fontSize: "2.2mm" }}><span dir="rtl">الرقم الضريبي / {props.model.store?.vat_no_in_arabic ? props.model.store.vat_no_in_arabic : (props.model.store?.vat_no ? convertToArabicNumber(props.model.store.vat_no) : "<STORE_VAT_NO_ARABIC>")}</span></li>
                        </ul>
                    </div>
                </div>
                <div className="row">
