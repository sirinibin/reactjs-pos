                ...
                <div className="row" style={{ fontSize: "3mm" }}>
                    <div className="col">
                        <ul className="list-unstyled text-left">
                            {props.model.store?.store_name && <li><h4 style={{ fontSize: "5.5mm", fontWeight: 700 }}>{props.model.store.store_name}</h4></li>}
                    ...
                    <div className="col">
                        <ul className="list-unstyled text-end">
                            {props.model.store?.store_name_in_arabic && <h4 style={{ fontSize: "5.5mm", fontWeight: 700 }}><strong>{props.model.store.store_name_in_arabic}</strong></h4>}
                            <li>
