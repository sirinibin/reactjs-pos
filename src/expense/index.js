...
function ExpenseIndex(props) {
    ...
    const { columns, showSettings, setShowSettings, handleToggleColumn, onDragEnd, restoreDefaults } = useTableSettings({ storageKey: "expense_table_settings", selectStorageKey: "select_expense_table_settings", defaultColumns, enableSelection });
