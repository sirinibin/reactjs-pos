...
function ExpenseCategoryIndex(props) {
    ...
    //Created By ExpenseCategory Auto Suggestion
    const [expensecategoryOptions, setExpenseCategoryOptions] = useState([]);
    const [selectedCreatedByExpenseCategorys, setSelectedCreatedByExpenseCategorys] = useState([]);
    ...
    let [sortExpenseCategory, setSortExpenseCategory] = useState("-");
    ...
    async function suggestUsers(searchTerm) {
        ...
        setExpenseCategoryOptions(data.result);
    }
    ...
    function searchByMultipleValuesField(field, values) {
        if (field === "created_by") {
            setSelectedCreatedByExpenseCategorys(values);
        }
    ...
    function list() {
        ...
        fetch(
            ...
            .then(async (response) => {
                ...
                setExpenseCategoryList(data.result);
    ...
    function sort(field) {
        ...
        sortExpenseCategory = sortExpenseCategory === "-" ? "" : "-";
        setSortExpenseCategory(sortExpenseCategory);
        list();
    }
    ...
    return (
        <>
            <ExpenseCategoryCreate ref={CreateFormRef} refreshList={list} showToastMessage={props.showToastMessage} openDetailsView={openDetailsView} />
            <ExpenseCategoryView ref={DetailsViewRef} openUpdateForm={openUpdateForm} openCreateForm={openCreateForm} />
  ...
  <div   className="card-header">
                    ...
                    */}
                            <div className="card-body">
                                ...
                                <div className="row" style={{ bexpensecategory: "solid 0px" }}>
                                    <div className="col text-start" style={{ bexpensecategory: "solid 0px" }}>
                                        <Button
                                            onClick={() => {
                                        ...
                                        {totalItems > 0 && (
                                            <>
                                                ...
                                                <select
                                                    ...
                                                    style={{
                                                        bexpensecategory: "solid 1px",
                                                        bexpensecategoryColor: "silver",
                                                        width: "55px",
                                                    }}
                                                >
                                                    <option value="5">
                                ...
                                <br />
                                <div className="row">
                                    <div className="col" style={{ bexpensecategory: "solid 0px" }}>
                                                    ...
                                                    <tr key={expensecategory.id}>
                                                        ...
                                                        <td style={{ width: "auto", whiteSpace: "nowrap" }} >
                                                            ...
                                                            <Button className="btn btn-primary btn-sm" onClick={() => {
                                                                openDetailsView(expensecategory.id);
                                                            }}>
