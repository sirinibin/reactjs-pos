            ...
            <Modal show={show} size="xl" fullscreen
                ...
                <Modal.Body>
                    ...
                    <form className="row g-3 needs-validation" onSubmit={e => { e.preventDefault(); handleCreate(e); }} >
                        ...
                        <div className="col-md-1">
                            <Button className={`btn ${!formData.customer?.phone && !formData.phone ? "btn-secondary" : "btn-success"} btn-sm`} disabled={!formData.customer?.phone && !formData.phone} style={{ marginTop: "30px" }} onClick={sendWhatsAppMessage}>
