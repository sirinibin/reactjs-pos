...
const OrderCreate = forwardRef((props, ref) => {
    ...
    const suggestProducts = useCallback(async (searchTerm) => {
        ...
        // Split letter↔digit boundaries only when both sides are 2+ chars,
        // so "toy116" → "toy 116" but short part numbers like "5M" are left intact.
    ...
    */
    ...
    return (
        <>
            <style>{`.order-create-wrap { z-index: 1080 !important; } .pw-modal-wrap { z-index: 1085 !important; } .vehicle-list-modal-wrap { z-index: 1086 !important; } .order-preview-wrap { z-index: 1090 !important; } .products-modal-wrap { z-index: 1095 !important; } .above-sales-modal { z-index: 1082 !important; }`}</style>
                                        ...
                                        return (
                                            <div className="sc-header-right" style={{ padding: '4px 14px', background: 'rgba(0,74,198,0.03)', borderLeft: '1px solid #e2e8f0', display: 'flex', alignItems: 'center', flexWrap: 'wrap', gap: '6px', overflow: 'hidden', minHeight: '40px' }}>
                                                ...
                                                <span style={{ display: 'inline-flex', alignItems: 'center', gap: '4px', fontSize: '11px', cursor: 'pointer', userSelect: 'none', flexShrink: 0 }}
                                                    ...
                                                    <strong style={{ color: (c.credit_balance || 0) > 0 ? '#dc2626' : '#16a34a' }}><Amount amount={trimTo2Decimals(c.credit_balance || 0)} /></strong>
                                                                                    ...
                                                                                    return (
                                                                                        <React.Fragment key={col.key}>
                                                                                            ...
                                                                                            {col.key === "rack" && (() => {
                                                                                                ...
                                                                                                return <div style={{ ...columnStyle, width: getColumnWidth(col) }}>{option.rack_name}</div>;
                                                                                            })()}
                                                                                        </React.Fragment>
                                                                                    )
                                                                                })}
