...
const OrderPrintContent = forwardRef((props, ref) => {
    ...
    return (<>
        ...
        >
            <h4 style={{ fontSize: "3mm", position: "absolute", left: "100px", top: "14px", border: "solid " + border + "px", }}>
                {props.model.customer && props.model.customer.name ? props.model.customer.name : "N/A"}
            </h4>
            <h4 style={{ fontSize: "3mm", position: "absolute", left: "100px", top: "28px", border: "solid " + border + "px", }}>
                {props.model.customer && props.model.customer.name_in_arabic ? props.model.customer.name_in_arabic : "N/A"}
            </h4>

            <h4 style={{ fontSize: "3mm", position: "absolute", left: "100px", top: "46px", border: "solid " + border + "px", }}>
                {props.model.customer && props.model.customer.vat_no ? props.model.customer.vat_no : "N/A"}
            </h4>
            <h4 style={{ fontSize: "3mm", position: "absolute", left: "105px", top: "60px", border: "solid " + border + "px", }}>
                {props.model.customer && props.model.customer.vat_no_in_arabic ? props.model.customer.vat_no_in_arabic : "N/A"}
            </h4>


            <h4 style={{ fontSize: "3mm", position: "absolute", left: "570px", top: "14px", border: "solid " + border + "px", }}>
            ...
            <table style={{ fontSize: "3mm", position: "absolute", left: "18px", top: "116px", border: "solid 0px", }}>
                <tbody>
                    {props.model.products && props.model.products.map((product, index) => (
                        <tr key={product.item_code} style={{ height: "16px", verticalAlign: "center", borderBottom: "solid 1px" }}>
                            ...
                            <td className="text-left" style={{ border: "solid 0px", width: "299px", paddingLeft: "5px", verticalAlign: "center", paddingTop: "2px" }} >
                                {(product.name || product.name_in_arabic) ? <h4 style={{ fontSize: "3mm" }}>
                                    <ul
                                        className="list-unstyled"
                                        style={{ fontSize: "3mm", height: "16px", marginBottom: "0px", verticalAlign: "center", }}
                                    >
            ...
            <table style={{ fontSize: "3mm", position: "absolute", left: "646px", top: "509px", border: "solid 1px", }}>
                <tbody>
                    <tr className="text-end" style={{ height: "17px", verticalAlign: "center", border: "solid 1px", }}>
                    ...
                    <tr className="text-end" style={{ height: "17px", verticalAlign: "center", border: "solid 0px", }}>
                        <td style={{ width: "99px", paddingRight: "5px", paddingTop: "10px" }}>
                            <h4 style={{ fontSize: "3mm", }}>
                                <NumberFormat
            ...
            <div className="row">
                <div className="col">
                    <u
                    ><h4 className="text-center" style={{ fontSize: "3mm" }}>
                            INVOICE / فاتورة
                        </h4>
                    </u>
                </div>
