    ...
    return (<>
        ...
        {props.model.pages && props.model.pages.map((page, pageIndex) => (
            ...
            >
                ...
                {page.lastPage ? <div style={{ position: "absolute", left: "575px", top: (630 + page.top) + "px" }} >
                    {props.model.QRImageData && <img style={{ width: "172px", height: "164px" }} src={props.model.QRImageData} alt="Invoice QR Code" />}
                </div> : ""}
            </div >
        ))}
    </>);
