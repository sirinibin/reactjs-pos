...
const OrderPrintContent = forwardRef((props, ref) => {
    ...
    return (<>
        ...
        >
            ...
            <div style={{ position: "absolute", left: "575px", top: "622px" }} >
                {props.model.QRImageData && <img style={{ width: "182px", height: "176px" }} src={props.model.QRImageData} alt="Invoice QR Code" />}
            </div>
