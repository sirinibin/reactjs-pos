...
const OrderPrintContent = forwardRef((props, ref) => {
    ...
    return (<>
        ...
        >
            <div className="row" style={{ fontSize: "4mm", position: "relative", left: "117px", top: "0px", border: "solid 0px", }}>
                {props.model.customer ? props.model.customer.name : ""}
            </div>
            <div style={{ fontSize: "4mm", position: "relative", left: "105px", top: "0px", border: "solid 0px", }}>
