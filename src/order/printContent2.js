        ...
        <span ref={ref}>
            {props.model.pages && props.model.pages.map((page, pageIndex) => (
                ...
                >
                    ...
                    <h4 className="print-value text-center" style={{ fontSize: "3mm", maxWidth: "450px", minWidth: "450px", position: "absolute", left: "350px", top: (236 + page.top) + "px", border: "solid " + border + "px", }}>
                    ...
                    {page.lastPage ? <div className="print-value" style={{ position: "absolute", left: "95px", top: (660 + page.top) + "px" }} >
