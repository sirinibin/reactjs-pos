...
const OrderPrintContent3 = forwardRef((props, ref) => {
    //Non-A4
    let border = "0";
    return (<>
        <span ref={ref}>
            {props.model.pages && props.model.pages.map((page, pageIndex) => (
                ...
                >
                    <h2 className="print-value" style={{ textAlign: "center", minWidth: "350px", fontSize: "4mm", position: "absolute", left: "215px", top: (100 + page.top) + "px", border: "solid " + border + "px", textDecoration: "underline", }}>
                        {/*"TAX INVOICE / فاتورة ضريبية"*/}
                        {props.model.invoiceTitle}
                    </h2>

                    <h4 className="print-value text-center" style={{ textAlign: "center", fontSize: "3mm", position: "absolute", left: "320px", top: (130 + page.top) + "px", border: "solid " + border + "px", }}>
                    ...
                    {props.model.store?.settings?.enable_automobile_module && props.model?.vehicle_snapshot && (
                        <>
                            <h4 className="print-value" style={{ fontSize: "2.8mm", maxWidth: "450px", minWidth: "450px", position: "absolute", left: "300px", top: (182 + page.top) + "px", border: "solid " + border + "px", }}>
                            ...
                            {(props.model.vehicle_snapshot.year || props.model.vehicle_snapshot.current_km) && (
                                <h4 className="print-value" style={{ fontSize: "2.6mm", maxWidth: "450px", minWidth: "450px", position: "absolute", left: "300px", top: (197 + page.top) + "px", border: "solid " + border + "px", }}>
                    ...
                    < table className="print-value" style={{ fontSize: "3mm", position: "absolute", left: "25px", top: (250 + page.top) + "px", border: "solid 0px", }}>
                        <tbody>
                            {page.products && page.products.map((product, index) => (
                                <tr key={product.item_code} style={{ paddingTop: "1px", height: "6px", borderBottom: "solid 1px" }}>
                                    ...
                                    <td className="text-left" style={{ border: "solid 0px", width: "125px", height: "auto", }} >
                                    ...
                                    <td className="text-left" style={{ border: "solid 0px", width: "365px", paddingLeft: "15px" }} >
                                        {props.model?.store?.settings?.one_line_product_name_in_print_invoice && <div
                                            style={{ //one_line_product_name_in_invoice
                                                display: 'inline-block',
                                                maxWidth: `365px`,
                                    ...
                                    <td className="text-end" style={{ border: "solid 0px", width: "96px", paddingRight: "5px" }} >
                    ...
                    {page.lastPage ? <table className="print-value" style={{ minWidth: "150px", fontSize: "3mm", position: "absolute", left: "620px", top: (820 + page.top) + "px", border: "solid 0px", }}>
                        <tbody>
                    ...
                    {page.lastPage && props.model?.modelName !== "delivery_note" ? <h4 className="print-value" style={{ fontSize: "3.5mm", position: "absolute", left: "35px", top: (910 + page.top) + "px" }}>
                        {n2words(props.model.net_total, { lang: 'en' }) + " saudi riyals"}
                    </h4> : ""}

                    {page.lastPage && props.model?.modelName !== "delivery_note" ? <h4 className="print-value" dir="rtl" style={{ fontSize: "3.5mm", position: "absolute", right: "300px", top: (918 + page.top) + "px" }}>
                    ...
                    {page.lastPage && props.model?.modelName !== "quotation" && props.model?.modelName !== "quotation_sales_return" && props.model?.modelName !== "delivery_note" ? <div className="print-value" style={{ position: "absolute", left: "40px", top: (700 + page.top) + "px" }} >
                    ...
                    <h4 className="print-value" style={{ fontSize: "4.7mm", position: "absolute", left: "120px", top: (880 + page.top) + "px", border: "solid " + border + "px", }}>
                        {props.model.customer && props.model.customer.vat_no ? props.model.customer.vat_no : "N/A"}
                    </h4>
                </div >
...
export default OrderPrintContent3;