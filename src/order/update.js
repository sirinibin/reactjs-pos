...
function OrderUpdate(props) {
    ...
    function handleUpdate(event) {
        ...
        setProcessing(true);
        fetch("/v1/order/" + formData.id, requestOptions)
            .then(async (response) => {
            ...
            .catch((error) => {
                ...
                props.showToastMessage("Error Updating Order!", "danger");
            });
    }
    ...
    function addProduct() {
        ...
        // selectedProduct[0].quantity = parseInt(selectedProduct[0].quantity);
    ...
    return (
        <>
            ...
            <Modal show={show} size="lg" onHide={handleClose} animation={false} backdrop={true}>
                <Modal.Header>
                    <Modal.Title>Update Order #{formData.code}</Modal.Title>
