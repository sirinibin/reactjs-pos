        ...
        {props.model.pages && props.model.pages.map((page, pageIndex) => (
            ...
            >
                ...
                <div className="row table-active" style={{ fontSize: "3.5mm", border: "solid 0px" }}>
                    <div className="col-md-5" style={{ border: "solid 0px", width: `${props.model.store?.zatca_qr_on_left_bottom ? "90%" : "79%"}` }}>
                        <div className="container" style={{ border: "solid 0px", paddingLeft: "0px", fontSize: "2.2mm" }}>
                            {props.model.invoice_count_value && props.model.store?.zatca?.phase === "2" ? <div className="row" style={{ border: "solid 0px" }}>
                                ...
                                <div className="col-5 fw-bold" style={{ border: "solid 0px", marginLeft: `${props.model.store?.zatca_qr_on_left_bottom ? "-235px" : "-180px"}` }} dir="ltr">
                            ...
                            {props.model.uuid && props.model.store?.zatca?.phase === "2" ? <div className="row">
                                ...
                                <div className="col-6 fw-bold" style={{ marginLeft: `${props.model.store?.zatca_qr_on_left_bottom ? "-235px" : "-180px"}` }} dir="ltr">
                            ...
                            <div className="row">
                                ...
                                <div className="col-6 fw-bold" dir="ltr" style={{ marginLeft: `${props.model.store?.zatca_qr_on_left_bottom ? "-235px" : "-180px"}` }}>
                    ...
                    {!props.model.store?.zatca_qr_on_left_bottom && <div className="col-md-2 text-center" style={{ border: "solid 0px", width: "21%", padding: "0px", marginLeft: "0px" }}>
                                ...
                                <tfoot style={{ fontSize: "2.2mm" }} className="fw-bold">
                                    <tr >
                                        {props.model.store?.zatca_qr_on_left_bottom && <th colSpan={2} rowSpan={6} style={{ maxWidth: "138px", maxHeight: "138px", }}>
                                            <div className="col-md-1 text-center" style={{ border: "solid 0px", padding: "0px", maxWidth: "138px", maxHeight: "138px", marginLeft: "0px", marginTop: "0px" }}>
                                                {props.model.store?.zatca?.phase === "1" && props.model.QRImageData ? <img className="text-start" src={props.model.QRImageData} style={{ width: "138px", height: "138px" }} alt="Invoice QR Code" /> : ""}
