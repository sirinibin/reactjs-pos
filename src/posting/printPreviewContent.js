    ...
    return (<>
        {props.model.pages && props.model.pages.map((page, pageIndex) => (
                                ...
                                >
                                    <tbody style={{ fontSize: props.fontSizes[props.modelName + "_tableBody"]?.size }} className="clickable-text print-value" onClick={() => {
                                        ...
                                        <tr style={{ borderBottom: tableBorderThickness, fontSize: props.fontSizes[props.modelName + "_tableHead"]?.size, height: "auto" }} onClick={(e) => {
                                            ...
                                            <th className="per10 text-center" style={{ padding: "0px", width: "24%", borderBottom: tableBorderThickness, borderRight: tableBorderThickness, }}>
                                                <ul
                                                    className="list-unstyled"
                                                    style={{
                                                        height: "auto"
                                            ...
                                            <th className="per3 text-center" colSpan={2} style={{ padding: "0px", width: "27%", borderRight: tableBorderThickness, borderBottom: tableBorderThickness }}>
                                                <ul
                                                    className="list-unstyled"
                                                    style={{
                                                        height: "auto",
                                            ...
                                            <th className="per68 text-center" colSpan={2} style={{ padding: "0px", width: "27%", borderRight: tableBorderThickness, borderBottom: tableBorderThickness }}>
                                                <ul
                                                    className="list-unstyled"
                                                    style={{
                                                        height: "auto",
            ...
            */}
                    ...
                    {
                        props.model.pages.length === (pageIndex + 1) && props.model.store?.settings?.show_address_in_invoice_footer ? <div className="clickable-text" style={{ fontSize: props.fontSizes[props.modelName + "_footer"]?.size, borderTop: "1px solid #ddd", padding: "5px 8px 3px", marginTop: "2px" }} onClick={() => {
