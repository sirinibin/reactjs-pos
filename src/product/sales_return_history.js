...
const SalesReturnHistory = forwardRef((props, ref) => {
    ...
    const { columns, showSettings, setShowSettings, handleToggleColumn, onDragEnd, restoreDefaults } = useTableSettings({ storageKey: "sales_return_history_table_settings", defaultColumns });
