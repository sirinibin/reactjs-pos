...
function ProductCategoryIndex(props) {
    ...
    //Created By ProductCategory Auto Suggestion
    const [productcategoryOptions, setProductCategoryOptions] = useState([]);
    const [selectedCreatedByProductCategorys, setSelectedCreatedByProductCategorys] = useState([]);
    ...
    let [sortProductCategory, setSortProductCategory] = useState("-");
    ...
    async function suggestUsers(searchTerm) {
        ...
        setProductCategoryOptions(data.result);
    }
    ...
    function searchByMultipleValuesField(field, values) {
        if (field === "created_by") {
            setSelectedCreatedByProductCategorys(values);
        }
    ...
    function list() {
        ...
        fetch(
            ...
            .then(async (response) => {
                ...
                setProductCategoryList(data.result);
    ...
    function sort(field) {
        ...
        sortProductCategory = sortProductCategory === "-" ? "" : "-";
        setSortProductCategory(sortProductCategory);
        list();
    }
    ...
    const parentCategoryNameSearchRef = useRef();
  ...
  <div   className="card-header">
                    ...
                    */}
                            <div className="card-body">
                                ...
                                <div className="row" style={{ bproductcategory: "solid 0px" }}>
                                    <div className="col text-start" style={{ bproductcategory: "solid 0px" }}>
                                        <Button
                                            onClick={() => {
                                ...
                                <br />
                                <div className="row">
                                    <div className="col" style={{ bproductcategory: "solid 0px" }}>
                                            ...
                                            <tr className="text-center">
                                                ...
                                                <th>
                                                    <input
                                                        ...
                                                        className="form-control"
                                                        id="product_parent_category_name"
                                                        name="product_parent_category_name"
                                                        ref={parentCategoryNameSearchRef}
                                                        onKeyDown={(e) => {
                                                            if (timerRef.current) clearTimeout(timerRef.current);
                                                            if (e.key === "Escape") {
                                                                timerRef.current = setTimeout(() => {
                                                                    parentCategoryNameSearchRef.current.value = "";
                                                                    searchByFieldValue("parent_name", "")
                                                                }, 100);
                                                            }
                                                        }}
                                                    />
