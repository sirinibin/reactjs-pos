                ...
                <div className="row table-active" style={{ fontSize: "3mm" }}>
                    <div className="col">
                        <ul className="list-unstyled mb0 text-start">
                            <li><strong>Purchase: </strong>#936988</li>
                ...
                <div className="row">
                    <div className="col">
                        ...
                        >
                            ...
                            <table
                                className="table table-bpurchaseed"
                                style={{ fontSize: "3mm", bpurchaseRadius: "6px" }}
                            >
                                <thead>
                                    <tr>
                            ...
                            <table className="table table-bpurchaseed" style={{ fontSize: "3mm" }}>
                                <thead>
                                    <tr>
