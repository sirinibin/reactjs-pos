...
const PurchasePreviewContent = forwardRef((props, ref) => {
                ...
                <div className="row">
                    <div className="col">
                        ...
                        ><h1 className="text-center" style={{ fontSize: "3mm" }}>
                                {props.model.payment_status === "not_paid" && props.model.store?.zatca?.phase === "1" ? "CREDIT PURCHASE TAX INVOICE | فاتورة ضريبة الائتمان" : ""} {props.model.store?.zatca?.phase === "1" && props.model.payment_status !== "not_paid" ? "PURCHASE TAX INVOICE | الفاتورة الضريبية" : ""}
                                {props.model.store?.zatca?.phase === "2" && props.model.zatca?.reporting_passed && props.model.zatca?.is_simplified ? "SIMPLIFIED PURCHASE TAX INVOICE | فاتورة ضريبية مبسطة" : ""}
                                {props.model.store?.zatca?.phase === "2" && !props.model.zatca?.is_simplified ? "STANDARD PURCHASE TAX INVOICE | فاتورة ضريبية قياسية" : ""}
                            </h1>
                        </u>
                    </div>
                </div>
                ...
                <div className="row table-active" style={{ fontSize: "3.5mm", border: "solid 0px" }}>
                    ...
                    <div className="col-md-5" style={{ border: "solid 0px", width: "40%" }}>
                        <ul className="list-unstyled mb0 text-end">
                            ...
                            <li>
                                {props.model.vendor?.name_in_arabic ? props.model.vendor.name_in_arabic : props.model.vendor?.name ? props.model.vendor.name : ""}<strong> :اسم العميل</strong>
                            </li>
...
export default PurchasePreviewContent;