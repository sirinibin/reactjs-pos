...
const PurchaseUpdate = forwardRef((props, ref) => {
    ...
    const [isOrderPlacedByUsersLoading, setIsOrderPlacedByUsersLoading] =
        useState(false);
    ...
    function handleUpdate(event) {
        ...
        setProcessing(true);
        fetch("/v1/purchase/" + formData.id, requestOptions)
            .then(async (response) => {
            ...
            .catch((error) => {
                ...
                props.showToastMessage("Error Updating Purchase!", "danger");
            });
    }
    ...
    function addProduct() {
        ...
        selectedProducts.push({
            ...
            item_code: selectedProduct[0].item_code,
                                ...
                                <select
                                    ...
                                    onChange={(e) => {
                                        ...
                                        if (!e.target.value) {
                                            ...
                                            setErrors({ ...errors });
                                            return;
                                            //{...formData.status === "created" ? "selected" : null}
                                        }
                            ...
                            <div className="input-group mb-3">
                                <Typeahead
                                    ...
                                    onChange={(selectedItems) => {
                                        ...
                                        console.log("selectedItems:", selectedProduct);
                                        setSelectedProduct([...selectedProduct]);
                                        console.log("selectedProduct:", selectedProduct);
                                    }}
