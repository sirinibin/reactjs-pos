...
function PurchaseReturnIndex(props) {
    ...
    const { columns, showSettings, setShowSettings, handleToggleColumn, onDragEnd, restoreDefaults } = useTableSettings({ storageKey: "purchase_return_table_settings", selectStorageKey: "select_purchase_return_table_settings", pendingStorageKey: "pending_purchase_return_table_settings", defaultColumns, enableSelection, pendingView });
    ...
    return (
        <>
            ...
            <TableSettingsModal
                ...
                title="Purchase Return Settings"
                columns={columns}
            ...
            <div className="container-fluid p-0">
                ...
                <div className="row">
                    ...
                    <div className="col text-end">
                        ...
                        <ExcelFile filename={purchaseReturnReportFileName} element={excelData.length > 0 ? <Button variant="success" className="btn btn-primary mb-1 success" >{t('Download Purchase Return Report')}</Button> : ""}>
                            <ExcelSheet dataSet={excelData} name={purchaseReturnReportFileName} />
                        </ExcelFile>

                        {excelData.length === 0 ? <Button variant="primary" className="btn btn-primary mb-1" onClick={getAllPurchaseReturns} >{fettingAllRecordsInProgress ? t('Preparing..') : t('Purchase Return Report')}</Button> : ""}
                        &nbsp;&nbsp;
                                                            ...
                                                            return (<React.Fragment key={col.key}>
                                                                ...
                                                                {(col.fieldName === "payment_methods") && <td style={{ width: "auto", whiteSpace: "nowrap" }}>
                                                                    {purchaseReturn.payment_methods &&
                                                                        purchaseReturn.payment_methods.map((name, idx) => (
