            ...
            <div className="row table-active" style={{ fontSize: "3mm" }}>
                <div className="col">
                    <ul className="list-unstyled mb0 text-start">
                        ...
                        <li><strong>Purchase Return Date: </strong>{props.model.created_at ? format(
                                ...
                                <tr>
                                    ...
                                    <th style={{ width: "37%", height: "80px" }}>
                                        {props.model.purchase_returned_by_signature ?
                                            <img alt="Signature" rc={process.env.REACT_APP_API_URL + props.model.purchase_returned_by_signature.signature + "?" + (Date.now())} key={props.model.order_placed_by_signature.signature} style={{ width: 100, height: 80 }} ></img>
                                            : null}
                                    </th>
                                    <th className="text-end" style={{ padding: "0px" }}>
                                        <ul className="list-unstyled" style={{ fontSize: "3mm" }}>
