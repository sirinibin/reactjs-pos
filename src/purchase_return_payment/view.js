...
const PurchaseReturnPaymentView = forwardRef((props, ref) => {
    ...
    return (<>
        <Modal show={show} size="lg" onHide={handleClose} animation={false} scrollable={true}>
            <Modal.Header>
                <Modal.Title>Details of Purchase Return Payment  of Purchase return #{model.purchase_return_code} </Modal.Title>
            ...
            <Modal.Body>
                <Table striped bordered hover responsive="lg">
                    <tbody>
                        <tr>
                            <th>Purchase Return ID:</th><td> {model.purchase_return_code}</td>
                            <th>Purchase Purchase ID:</th><td> {model.purchase_code}</td>
