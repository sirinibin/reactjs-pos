...
import QuotationPrintContent from './printContent.js';
...
const QuotationPrint = forwardRef((props, ref) => {
    ...
    */
    ...
    return (<>
        <Modal show={show} scrollable={true} fullscreen onHide={handleClose} animation={false} style={{ overflowY: "auto", height: "auto" }}>
            <Modal.Header>
            ...
            <Modal.Body>
                <div ref={printAreaRef}>
                    <QuotationPrintContent model={model} />
                </div>
            </Modal.Body>
            <Modal.Footer>
                {/*
