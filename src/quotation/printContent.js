...
const QuotationPrintContent = forwardRef((props, ref) => {
    ...
    return (<>
        ...
        {props.model.pages && props.model.pages.map((page, pageIndex) => (
            ...
            >
                <h2 style={{ fontSize: "4mm", position: "absolute", left: "305px", top: (120 + page.top) + "px", border: "solid " + border + "px", textDecoration: "underline", }}>
                    {"QUOTATION / اقتباس"}
                </h2>
