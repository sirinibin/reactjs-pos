...
import { trimTo4Decimals } from "../utils/numberUtils.js";
            ...
            .then(async response => {
                ...
                if (!saleReturnID) {
                    ...
                    */
                    ...
                    formData.cash_discount = parseFloat(quotation.cash_discount - quotation.return_cash_discount);
                ...
                <Modal.Body>
                    ...
                    {selectedProducts && selectedProducts.length > 0 && <form className="row g-3 needs-validation" onSubmit={handleCreate}>
                                        ...
                                        <tr key={index} className="text-center">
                                            ...
                                            >
                                                <div className="input-group">
                                                    <input type="text" id={`${"quotationsales_return_product_name" + index}`}
                                                        name={`${"quotationsales_return_product_name" + index}`}
                                                    ...
                                                    <Dropdown drop="top">
                                                        ...
                                                        <Dropdown.Menu style={{ zIndex: 9999, position: "absolute" }} popperConfig={{ modifiers: [{ name: 'preventOverflow', options: { boundary: 'viewport' } }] }}>
                                                            ...
                                                            <Dropdown.Item onClick={() => {
                                                                ...
                                                                <i className="bi bi-clock-history"></i>
                                                                &nbsp;
                                                                QuotationSales Return History (F9)
                                                            </Dropdown.Item>
                                                            <Dropdown.Item onClick={() => {
                                                                openPurchaseHistory(product);
                                                            }}>
                        ...
                        <div className="col-md-2">
                            ...
                            <input id="quotationsales_return_cash_discount" name="quotationsales_return_cash_discount"
