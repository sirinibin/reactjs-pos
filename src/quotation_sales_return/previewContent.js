...
const QuotationSalesReturnPreviewContent = forwardRef((props, ref) => {
                ...
                <div className="row">
                    <div className="col">
                        ...
                        ><h1 className="text-center" style={{ fontSize: "3mm" }}>
                                ...
                                {props.model.store?.zatca?.phase === "1" ? "QUOTATIONSALES RETURN TAX INVOICE | فاتورة ضريبة المبيعات المرتجعة" : ""}
...
export default QuotationSalesReturnPreviewContent;