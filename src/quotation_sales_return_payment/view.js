...
const QuotationSalesReturnPaymentView = forwardRef((props, ref) => {
    ...
    function getQuotationSalesReturnPayment(id) {
        console.log("inside get QuotationSalesReturnPayment");
    ...
    return (<>
        <Modal show={show} size="lg" onHide={handleClose} animation={false} scrollable={true}>
            <Modal.Header>
                <Modal.Title>Details of QuotationSales Return Payment  of QuotationSales return #{model.quotationsales_return_code} </Modal.Title>

                <div className="col align-self-end text-end">
                    {props.openCreateForm ? <Button variant="primary" onClick={() => {
                        handleClose();
                        props.openCreateForm(props.quotationsales_return);
                    }}>
            ...
            <Modal.Body>
                <Table striped bordered hover responsive="lg">
                    <tbody>
                        <tr>
                            <th>QuotationSales Return ID:</th><td> {model.quotationsales_return_code}</td>
                            <th>QuotationSales Order ID:</th><td> {model.order_code}</td>
