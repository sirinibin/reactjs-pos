/**
 * Smoke tests for the ZATCA gate condition change in SalesReturnIndex.
 *
 ...
 *
 * This file verifies the component renders without crashing with various ZATCA states.
 */
...
jest.mock('../create.js', () => { const R = require('react'); return { __esModule: true, default: R.forwardRef((_props, _ref) => null) }; });
jest.mock('../view.js',   () => { const R = require('react'); return { __esModule: true, default: R.forwardRef((_props, _ref) => null) }; });

jest.mock('../../sales_return_payment/create.js', () => { const R = require('react'); return { __esModule: true, default: R.forwardRef((_props, _ref) => null) }; });
jest.mock('../../sales_return_payment/view.js',   () => { const R = require('react'); return { __esModule: true, default: R.forwardRef((_props, _ref) => null) }; });
jest.mock('../../sales_return_payment/index.js',  () => { const R = require('react'); return { __esModule: true, default: R.forwardRef((_props, _ref) => null) }; });

jest.mock('../../order/preview.js', () => { const R = require('react'); return { __esModule: true, default: R.forwardRef((_props, _ref) => null) }; });
jest.mock('../../order/report.js',  () => { const R = require('react'); return { __esModule: true, default: R.forwardRef((_props, _ref) => null) }; });
jest.mock('../../order/print.js',   () => { const R = require('react'); return { __esModule: true, default: R.forwardRef((_props, _ref) => null) }; });
jest.mock('../../order/create.js',  () => { const R = require('react'); return { __esModule: true, default: R.forwardRef((_props, _ref) => null) }; });
jest.mock('../../customer/create.js',() => { const R = require('react'); return { __esModule: true, default: R.forwardRef((_props, _ref) => null) }; });
...
const EMPTY_META = {
  total_sales_return: 0, net_profit: 0, net_loss: 0, vat_price: 0,
  shipping_handling_fees: 0, discount: 0, cash_discount: 0,
  commission: 0, commission_paid_by_cash: 0, commission_paid_by_bank: 0,
  paid_sales_return: 0, unpaid_sales_return: 0, cash_sales_return: 0,
  bank_account_sales_return: 0, sales_sales_return: 0,
};

describe('SalesReturnIndex ZATCA gate (zatca_reconnect_required)', () => {
  beforeEach(() => {
    jest.useFakeTimers();
  ...
  it('ZATCA gate: component renders without crashing when reconnect_required=true in store prop', () => {
    // Simulate the parent passing a store with zatca_reconnect_required=true.
    // The gate condition hides ZATCA columns, so the component must not crash.
    const { container } = render(
      <MemoryRouter>
        <SalesReturnIndex
          showToastMessage={jest.fn()}
          store={{ zatca: { phase: '2', connected: true, zatca_reconnect_required: true } }}
        />
      </MemoryRouter>
    );
    expect(container).toBeTruthy();
  ...
  it('ZATCA gate: component renders without crashing when reconnect_required=false in store prop', () => {
    const { container } = render(
      <MemoryRouter>
        <SalesReturnIndex
          showToastMessage={jest.fn()}
          store={{ zatca: { phase: '2', connected: true, zatca_reconnect_required: false } }}
        />
      </MemoryRouter>
    );
    expect(container).toBeTruthy();
