...
const SalesReturnCreate = forwardRef((props, ref) => {
    ...
    */
    ...
    //Deceived By Auto Suggestion
    const [receivedByUserOptions, setReceivedByUserOptions] = useState([]);
    const [selectedReceivedByUsers, setSelectedReceivedByUsers] = useState([]);
    ...
    return (
        <>
            ...
            <Modal show={show} size="xl" onHide={handleClose} animation={false} backdrop={true}>
                <Modal.Header>
                    <Modal.Title>
                        {formData.id ? "Update SalesReturn #" + formData.code : "Create New Sales Return for Order #" + formData.order_code}
                    </Modal.Title>
                        ...
                        <div className="col-md-6">
                            ...
                            <div className="input-group mb-3">
                                <select
                                    ...
                                    className="form-control"
                                >
                                    <option value="salesreturn_placed">SalesReturn Placed</option>
