                            ...
                            <table className="table table-striped table-sm table-bordered">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td className="text-end">
                                            <input type="number" id="sales_return_discount_with_vat" name="sales_return_discount_with_vat" onWheel={(e) => e.target.blur()} style={{ width: "150px" }} className="text-start" value={discountWithVAT} onChange={(e) => {
                                                if (timerRef.current) clearTimeout(timerRef.current);
                                                if (parseFloat(e.target.value) === 0) {
                                                    discount = 0;
                                                    discountWithVAT = 0;
