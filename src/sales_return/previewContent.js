            ...
            < div className="row">
                <div className="col">
                    ...
                    >
                        ...
                        <table
                            className="table table-bsalesreturned"
                        ...
                        <table className="table table-bsalesreturned" style={{ fontSize: "3mm" }}>
                            <thead>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <th style={{ width: "37%", height: "80px" }}>
                                        {props.model.received_by_signature ?
                                            <img alt="Signature" src={process.env.REACT_APP_API_URL + props.model.received_by_signature.signature + "?" + (Date.now())} key={props.model.received_by_signature.signature} style={{ width: 100, height: 80 }} ></img>
                                            : null}
                                    </th>
                                    <th className="text-end" style={{ padding: "0px" }}>
                                        <ul className="list-unstyled" style={{ fontSize: "3mm" }}>
