...
export const DEFAULT_MENU = [
    ...
    { id: "qtn_sales_return", resource: "qtn_sales_return", label: "Quotation Sales Returns", path: "/dashboard/quotation_sales_returns", icon: "bi-clipboard2-minus", requiresSalesInQuotation: true },
    { id: "non_vat_sales", resource: "non_vat_sales", label: "Non VAT Sales", path: "/dashboard/non-vat-sales", icon: "bi-receipt-cutoff", requiresNonVATSales: true },
    { id: "non_vat_sales_return", resource: "non_vat_sales_return", label: "Non VAT Sales Returns", path: "/dashboard/non-vat-sales-returns", icon: "bi-receipt", requiresNonVATSales: true },
