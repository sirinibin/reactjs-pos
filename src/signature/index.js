...
function SignatureIndex(props) {
    ...
    let [sortSignature, setSortSignature] = useState("-");
    ...
    function sort(field) {
        ...
        setSortSignature(sortSignature);
        list();
    }
  ...
  <div   className="card-header">
                    ...
                    */}
                            <div className="card-body">
                                ...
                                <div className="row" style={{ bsignature: "solid 0px" }}>
                                    <div className="col text-start" style={{ bsignature: "solid 0px" }}>
                                        <Button
                                            onClick={() => {
                                        ...
                                        {totalItems > 0 && (
                                            <>
                                                ...
                                                <select
                                                    ...
                                                    style={{
                                                        bsignature: "solid 1px",
                                                        bsignatureColor: "silver",
                                                        width: "55px",
                                                    }}
                                                >
                                ...
                                <br />
                                <div className="row">
                                    <div className="col" style={{ bsignature: "solid 0px" }}>
                                        <ReactPaginate
                                            breakLabel="..."
                                            nextLabel="next >"
                                            onPageChange={(event) => {
                                ...
                                <div className="table-responsive" style={{ overflowX: "auto" }}>
                                    <table className="table table-striped table-sm table-bsignatureed">
                                        <thead>
                                            ...
                                            {signatureList &&
                                                signatureList.map((signature) => (
                                                    <tr>
                                                        ...
                                                        <td>{signature.created_by_name}</td>
                                                        <td>
                                                            {format(
                                                        ...
                                                        <td>
                                                            <Button className="btn btn-light btn-sm" onClick={() => {
                                                                openUpdateForm(signature.id);
                                                            }}>
                                                                <i className="bi bi-pencil"></i>
                                                            </Button>

                                                            <Button className="btn btn-primary btn-sm" onClick={() => {
                                                                openDetailsView(signature.id);
                                                            }}>
