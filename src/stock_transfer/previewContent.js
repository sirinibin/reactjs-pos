            ...
            {props.model.pages && props.model.pages.map((page, pageIndex) => (
                ...
                >
                    ...
                    <div style={{ position: "relative", zIndex: 1 }}>
                        ...
                        {!props.model.printing && props.model.code && props.model.store?.zatca?.phase === "2" && props.model.zatca?.reporting_passed && (<div className="row no-print" style={{ height: "18px", lineHeight: "14px", bstocktransfer: "none", fontSize: "0.95rem" }} >
                            <div className="col text-end">
                                <div className="no-print" style={{ marginTop: 0, bstocktransfer: "none", height: "32px" }}>
                                    ...
                                    <a
                                        ...
                                        className="no-print"
                                        style={{ height: "18px", lineHeight: "14px", bstocktransfer: "none", fontSize: "0.75rem", cursor: "pointer", opacity: 1 }}
                                    ...
                                    rel="noopener noreferrer"
                                    className="no-print"
                                    style={{ height: "18px", lineHeight: "14px", bstocktransfer: "none", fontSize: "0.75rem" }}
                                >
                                    Zatca Signed XML
                                </a>*/}
                                </div>
                        ...
                        <div className="row col-md-14" style={{ bstocktransfer: "solid 0px", bstocktransferColor: detailsBstocktransferColor, fontSize: props.fontSizes[props.modelName + "_invoiceDetails"]?.size, padding: "10px" }} onClick={() => {
                            ...
                            <div className="col-md-12" style={{ bstocktransfer: detailsBstocktransferThickness, bstocktransferColor: detailsBstocktransferColor, marginLeft: "0px", width: `${(props.model.store?.settings?.zatca_qr_on_left_bottom || (props.modelName === "quotation" && props.model.type !== "invoice")) ? "100%" : "74%"}` }}>
                                ...
                                {props.modelName === "stocktransfers" || props.modelName === "whatsapp_stocktransfers" || props.modelName === "stocktransfers_return" || props.modelName === "quotation_stocktransfers_return" || props.modelName === "whatsapp_stocktransfers_return" || props.modelName === "whatsapp_quotation_stocktransfers_return" || props.modelName === "quotation" || props.modelName === "whatsapp_quotation" || props.modelName === "delivery_note" || props.modelName === "whatsapp_delivery_note" ? <>
                                    <div className="row" dir="ltr" style={{ bstocktransferBottom: detailsBstocktransferThickness }} >
                                        <div className="col-md-4 print-label" dir="ltr" style={{ bstocktransferRight: detailsBstocktransferThickness, bstocktransferColor: detailsBstocktransferColor, width: detailsLabelsColumnWidthPercent, padding: "3px" }} ><b>Customer Name | اسم العميل:</b></div>
                                    ...
                                    <div className="row" dir="ltr" style={{ bstocktransferBottom: detailsBstocktransferThickness }} >
                                        <div className="col-md-4 print-label" dir="ltr" style={{ bstocktransferRight: detailsBstocktransferThickness, bstocktransferColor: detailsBstocktransferColor, width: detailsLabelsColumnWidthPercent, padding: "3px" }} ><b>Customer ID | معرف العميل:</b></div>
                                        <div className="col-md-8 print-value" dir="ltr" style={{ bstocktransferColor: detailsBstocktransferColor, width: detailsValuesColumnWidthPercent, padding: "3px" }} >
                                    ...
                                    <div className="row" dir="ltr" style={{ bstocktransferBottom: detailsBstocktransferThickness }} >
                                        <div className="col-md-4 print-label" dir="ltr" style={{ bstocktransferRight: detailsBstocktransferThickness, bstocktransferColor: detailsBstocktransferColor, width: detailsLabelsColumnWidthPercent, padding: "3px" }} ><b>Customer VAT  | ضريبة القيمة المضافة للعملاء:</b></div>
                                        <div className="col-md-8 print-value" dir="ltr" style={{ bstocktransferColor: detailsBstocktransferColor, width: detailsValuesColumnWidthPercent, padding: "3px" }} >
                                    ...
                                    <div className="row" dir="ltr" style={{ bstocktransferBottom: detailsBstocktransferThickness }} >
                                        <div className="col-md-4 print-label" dir="ltr" style={{ bstocktransferRight: detailsBstocktransferThickness, bstocktransferColor: detailsBstocktransferColor, width: detailsLabelsColumnWidthPercent, padding: "3px" }} ><b>Customer C.R | رقم تسجيل شركة العميل:</b></div>
                                        <div className="col-md-8 print-value" dir="ltr" style={{ bstocktransferColor: detailsBstocktransferColor, width: detailsValuesColumnWidthPercent, padding: "3px" }} >
                            ...
                            {!props.model.store?.settings?.zatca_qr_on_left_bottom && props.modelName !== "delivery_note" && props.modelName !== "whatsapp_delivery_note" && props.modelName !== "quotation" && props.modelName !== "quotation_stocktransfers_return" && props.modelName !== "whatsapp_quotation" && props.modelName !== "whatsapp_quotation_stocktransfers_return" && <div
                                className="col-md-2"
                                    ...
                                    <table className="table-responsive"
                                        ...
                                        {props.modelName !== "delivery_note" && <tbody style={{ fontSize: props.fontSizes[props.modelName + "_tableFooter"]?.size }} onClick={() => {
                                            ...
                                            <tr style={{ bstocktransferBottom: tableBstocktransferThickness }}>
                                                {props.model.store?.settings?.zatca_qr_on_left_bottom && props.modelName !== "quotation" && props.modelName !== "whatsapp_quotation" && props.modelName !== "quotation_stocktransfers_return" && props.modelName !== "whatsapp_quotation_stocktransfers_return" && props.modelName !== "delivery_note" && <th rowSpan={8} style={{ width: "20%", padding: "3px", bstocktransferRight: tableBstocktransferThickness }}>
                                                    <div
