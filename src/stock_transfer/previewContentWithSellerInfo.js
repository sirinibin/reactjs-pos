...
const PreviewContentWithSellerInfo = forwardRef((props, ref) => {
    ...
    let detailsBstocktransferThickness = "0.5px solid black";
    let detailsBstocktransferColor = "black";//#dee2e6
    let tableBstocktransferThickness = "0.5px solid black";
            ...
            {props.model.pages && props.model.pages.map((page, pageIndex) => (
                <div
                    ...
                    style={{
                        ...
                        bstocktransfer: "solid 0px",
                        bstocktransferColor: "silver",
                        bstocktransferRadius: "2mm",
                        paddingLeft: "0px",
                        paddingRight: "0px",
                        paddingTop: "10px",
                        paddingBottom: "4px",
                ...
                >
                    ...
                    <div style={{ position: "relative", zIndex: 1 }}>
                        ...
                        <div className="row col-md-14" style={{ bstocktransfer: "solid 0px", bstocktransferColor: detailsBstocktransferColor, fontSize: props.fontSizes[props.modelName + "_invoiceDetails"]?.size, padding: "10px" }} onClick={() => {
                            props.selectText("invoiceDetails");
                        }}>
                            <div className="col-md-12" style={{ bstocktransfer: detailsBstocktransferThickness, bstocktransferColor: detailsBstocktransferColor, marginLeft: "0px", width: `${(props.model.store?.settings?.zatca_qr_on_left_bottom || (props.modelName === "quotation" && props.model.type !== "invoice")) ? "100%" : "74%"}` }}>
                                {props.modelName === "quotation" && props.model.type !== "invoice" && <>
                                    <div className="row" dir="ltr" style={{ bstocktransferBottom: detailsBstocktransferThickness }} >
                                        <div className="col-md-4 print-label" dir="ltr" style={{ bstocktransferRight: detailsBstocktransferThickness, bstocktransferColor: detailsBstocktransferColor, width: detailsLabelsColumnWidthPercent, padding: "3px" }} ><b>Quotation No. | رقم الاقتباس:</b></div>
                                        <div className="col-md-8 print-value" dir="ltr" style={{ bstocktransferColor: detailsBstocktransferColor, width: detailsValuesColumnWidthPercent, padding: "3px" }} >{props.model.code ? props.model.code : ""}</div>
                                    </div>
                                    <div className="row" dir="ltr" style={{ bstocktransferBottom: detailsBstocktransferThickness }} >
                                        <div className="col-md-4 print-label" dir="ltr" style={{ bstocktransferRight: detailsBstocktransferThickness, bstocktransferColor: detailsBstocktransferColor, width: detailsLabelsColumnWidthPercent, padding: "3px" }} ><b>Quotation Date | تاريخ الاقتباس:</b></div>
                                        <div className="col-md-8 print-value" dir="ltr" style={{ bstocktransferColor: detailsBstocktransferColor, width: detailsValuesColumnWidthPercent, padding: "3px" }} >{props.model.date ? format(
                                ...
                                {(props.modelName !== "quotation" || props.model.type === "invoice") && <>
                                    <div className="row" dir="ltr" style={{ bstocktransferBottom: detailsBstocktransferThickness }} >
                                        <div className="col-md-4 print-label" dir="ltr" style={{ bstocktransferRight: detailsBstocktransferThickness, bstocktransferColor: detailsBstocktransferColor, width: detailsLabelsColumnWidthPercent, padding: "3px" }} >Invoice No. | رقم الفاتورة:</div>
                                        <div className="col-md-8 print-value" dir="ltr" style={{ bstocktransferColor: detailsBstocktransferColor, width: detailsValuesColumnWidthPercent, padding: "3px" }} >{props.model.code ? props.model.code : ""}</div>
                                    </div>
                                    <div className="row" dir="ltr" style={{ bstocktransferBottom: detailsBstocktransferThickness }} >
                                        <div className="col-md-4 print-label" dir="ltr" style={{ bstocktransferRight: detailsBstocktransferThickness, bstocktransferColor: detailsBstocktransferColor, width: detailsLabelsColumnWidthPercent, padding: "3px" }} ><b>Invoice Date | تاريخ الفاتورة:</b></div>
                                        <div className="col-md-8 print-value" dir="ltr" style={{ bstocktransferColor: detailsBstocktransferColor, width: detailsValuesColumnWidthPercent, padding: "3px" }} >{props.model.date ? format(
                                            new Date(props.model.date),
                                            "yyyy-MM-dd h:mma"
                                        ) : "<DATETIME>"} {" | " + getArabicDate(props.model.date)}</div>
                                ...
                                {props.model && props.model.stocktransfer_code && (props.modelName === "stocktransfers_return" || props.modelName === "whatsapp_stocktransfers_return") && <div className="row" dir="ltr" style={{ bstocktransferBottom: detailsBstocktransferThickness }} >
                                    <div className="col-md-4 print-label" dir="ltr" style={{ bstocktransferRight: detailsBstocktransferThickness, bstocktransferColor: detailsBstocktransferColor, width: detailsLabelsColumnWidthPercent, padding: "3px" }} ><b>Original Invoice No. | رقم الفاتورة الأصلية:</b></div>
                                    <div className="col-md-8 print-value" dir="ltr" style={{ bstocktransferColor: detailsBstocktransferColor, width: detailsValuesColumnWidthPercent, padding: "3px" }} >{props.model.stocktransfer_code ? props.model.stocktransfer_code : ""}</div>
                                </div>}
                                {props.model && props.model.stocktransfer_code && props.model.stocktransfer?.date && (props.modelName === "stocktransfers_return" || props.modelName === "whatsapp_stocktransfers_return") && <div className="row" dir="ltr" style={{ bstocktransferBottom: detailsBstocktransferThickness }} >
                                    <div className="col-md-4 print-label" dir="ltr" style={{ bstocktransferRight: detailsBstocktransferThickness, bstocktransferColor: detailsBstocktransferColor, width: detailsLabelsColumnWidthPercent, padding: "3px" }} ><b>Original Invoice Date | تاريخ الفاتورة الأصلية:</b></div>
                                    <div className="col-md-8 print-value" dir="ltr" style={{ bstocktransferColor: detailsBstocktransferColor, width: detailsValuesColumnWidthPercent, padding: "3px" }} >{props.model.stocktransfer?.date ? format(
                                        new Date(props.model.stocktransfer?.date),
                                        "yyyy-MM-dd h:mma"
                                    ) : "<DATETIME>"} {" | " + getArabicDate(props.model.stocktransfer?.date)}</div>
                                </div>}

                                {props.model && props.model.quotation_code && (props.modelName === "quotation_stocktransfers_return" || props.modelName === "whatsapp_quotation_stocktransfers_return") && <div className="row" dir="ltr" style={{ bstocktransferBottom: detailsBstocktransferThickness }} >
                                    <div className="col-md-4 print-label" dir="ltr" style={{ bstocktransferRight: detailsBstocktransferThickness, bstocktransferColor: detailsBstocktransferColor, width: detailsLabelsColumnWidthPercent, padding: "3px" }} ><b>Original Invoice No. | رقم الفاتورة الأصلية:</b></div>
                                    <div className="col-md-8 print-value" dir="ltr" style={{ bstocktransferColor: detailsBstocktransferColor, width: detailsValuesColumnWidthPercent, padding: "3px" }} >{props.model.quotation_code ? props.model.quotation_code : ""}</div>
                                </div>}
                                {props.model && props.model.quotation_code && props.model.quotation?.date && (props.modelName === "quotation_stocktransfers_return" || props.modelName === "whatsapp_quotation_stocktransfers_return") && <div className="row" dir="ltr" style={{ bstocktransferBottom: detailsBstocktransferThickness }} >
                                    <div className="col-md-4 print-label" dir="ltr" style={{ bstocktransferRight: detailsBstocktransferThickness, bstocktransferColor: detailsBstocktransferColor, width: detailsLabelsColumnWidthPercent, padding: "3px" }} ><b>Original Invoice Date | تاريخ الفاتورة الأصلية:</b></div>
                                    <div className="col-md-8 print-value" dir="ltr" style={{ bstocktransferColor: detailsBstocktransferColor, width: detailsValuesColumnWidthPercent, padding: "3px" }} >{props.model.quotation?.date ? format(
                                        new Date(props.model.quotation?.date),
                                        "yyyy-MM-dd h:mma"
                                    ) : "<DATETIME>"} {" | " + getArabicDate(props.model.quotation?.date)}</div>
                                </div>}

                                {props.model && props.model.purchase_code && (props.modelName === "purchase_return" || props.modelName === "whatsapp_purchase_return") && <div className="row" dir="ltr" style={{ bstocktransferBottom: detailsBstocktransferThickness }} >
                                    <div className="col-md-4 print-label" dir="ltr" style={{ bstocktransferRight: detailsBstocktransferThickness, bstocktransferColor: detailsBstocktransferColor, width: detailsLabelsColumnWidthPercent, padding: "3px" }} ><b>Original Invoice No. | رقم الفاتورة الأصلية:</b></div>
                                    <div className="col-md-8 print-value" dir="ltr" style={{ bstocktransferColor: detailsBstocktransferColor, width: detailsValuesColumnWidthPercent, padding: "3px" }} >{props.model.purchase_code ? props.model.purchase_code : ""}</div>
                                </div>}
                                {props.model && props.model.purchase_code && props.model.purchase?.date && (props.modelName === "purchase_return" || props.modelName === "whatsapp_purchase_return") && <div className="row" dir="ltr" style={{ bstocktransferBottom: detailsBstocktransferThickness }} >
                                    <div className="col-md-4 print-label" dir="ltr" style={{ bstocktransferRight: detailsBstocktransferThickness, bstocktransferColor: detailsBstocktransferColor, width: detailsLabelsColumnWidthPercent, padding: "3px" }} ><b>Original Invoice Date | تاريخ الفاتورة الأصلية:</b></div>
                                    <div className="col-md-8 print-value" dir="ltr" style={{ bstocktransferColor: detailsBstocktransferColor, width: detailsValuesColumnWidthPercent, padding: "3px" }} >{props.model.purchase?.date ? format(
                                        new Date(props.model.purchase?.date),
                                        "yyyy-MM-dd h:mma"
                                    ) : "<DATETIME>"} {" | " + getArabicDate(props.model.purchase?.date)}</div>
                                </div>}

                                {props.modelName === "stocktransfers" || props.modelName === "whatsapp_stocktransfers" || props.modelName === "stocktransfers_return" || props.modelName === "quotation_stocktransfers_return" || props.modelName === "whatsapp_stocktransfers_return" || props.modelName === "whatsapp_quotation_stocktransfers_return" || props.modelName === "quotation" || props.modelName === "whatsapp_quotation" || props.modelName === "delivery_note" || props.modelName === "whatsapp_delivery_note" ? <>

                                    <div className="row" dir="ltr" style={{ bstocktransferBottom: detailsBstocktransferThickness }} >
                                        <div className="col-md-4 print-label" dir="ltr" style={{ bstocktransferRight: detailsBstocktransferThickness, bstocktransferColor: detailsBstocktransferColor, width: detailsLabelsColumnWidthPercent, padding: "3px" }} >
                                            <b>Customer ID | معرف العميل</b>
                                        </div>
                                        <div className="col-md-8 print-value" dir="ltr" style={{ bstocktransferColor: detailsBstocktransferColor, width: detailsValuesColumnWidthPercent, padding: "3px" }} >
                                            {props.model.customer?.code ? props.model.customer.code : "N/A"}
                                        </div>
                                    </div>

                                    <div className="row" dir="ltr" style={{ bstocktransferBottom: detailsBstocktransferThickness }} >
                                        <div className="col-md-4 print-label text-center" dir="ltr" style={{ bstocktransferRight: detailsBstocktransferThickness, bstocktransferColor: detailsBstocktransferColor, width: "50%", padding: "3px" }} >
                                            <b>Seller Data | بيانات البائع</b>
                                        </div>
                                        <div className="col-md-8 print-value text-center" dir="ltr" style={{ bstocktransferColor: detailsBstocktransferColor, width: "50%", padding: "3px" }} >
                                            <b>Customer Data | بيانات العملاء</b>
                                        </div>
                                    </div>

                                    <div className="row" dir="ltr" style={{ bstocktransferBottom: detailsBstocktransferThickness }} >
                                        <div className="col-md-4 print-label text-center" dir="ltr" style={{ bstocktransferRight: detailsBstocktransferThickness, bstocktransferColor: detailsBstocktransferColor, width: "12.5%", padding: "3px" }} >
                                            <ul
                                        ...
                                        <div className="col-md-8 print-value text-center" dir="ltr" style={{ bstocktransferRight: detailsBstocktransferThickness, bstocktransferColor: detailsBstocktransferColor, width: "37.5%", padding: "3px" }} >
                                        ...
                                        <div className="col-md-8 print-value text-center" dir="ltr" style={{ bstocktransferColor: detailsBstocktransferColor, width: "37.5%", padding: "3px" }} >
                                    ...
                                    <div className="row" dir="ltr" style={{ bstocktransferBottom: detailsBstocktransferThickness }} >
                                        ...
                                        <div className="col-md-8 print-value text-center" dir="ltr" style={{ bstocktransferColor: detailsBstocktransferColor, width: "12.5%", padding: "3px", bstocktransferRight: detailsBstocktransferThickness }} >
                                        ...
                                        <div className="col-md-4 print-label text-center" dir="ltr" style={{ bstocktransferColor: detailsBstocktransferColor, bstocktransferRight: detailsBstocktransferThickness, width: "12.5%", padding: "3px" }} >
                                            <ul
                                                className="list-unstyled"
                                                style={{
                                                    height: "auto",
                                        ...
                                        <div className="col-md-8 print-value text-center" dir="ltr" style={{ bstocktransferColor: detailsBstocktransferColor, width: "12.5%", padding: "3px" }} >
                                    ...
                                    {/* <div className="row" dir="ltr" style={{}} >
                                    <div className="col-md-4 print-label" dir="ltr" style={{ bstocktransferRight: detailsBstocktransferThickness, bstocktransferColor: detailsBstocktransferColor, width: detailsLabelsColumnWidthPercent, padding: "3px" }} ><b>Customer Address | عنوان العميل:</b></div>
                                    <div className="col-md-8 print-value" dir="ltr" style={{ bstocktransferColor: detailsBstocktransferColor, width: detailsValuesColumnWidthPercent, padding: "3px" }} >
                                ...
                                {props.modelName === "purchase" || props.modelName === "whatsapp_purchase" || props.modelName === "purchase_return" || props.modelName === "whatsapp_purchase_return" ? <>
                                    <div className="row" dir="ltr" style={{ bstocktransferBottom: detailsBstocktransferThickness }} >
                                        <div className="col-md-4 print-label" dir="ltr" style={{ bstocktransferRight: detailsBstocktransferThickness, width: detailsLabelsColumnWidthPercent, padding: "3px" }} ><b>Vendor Name | اسم العميل:</b></div>
                                    ...
                                    <div className="row" dir="ltr" style={{ bstocktransferBottom: detailsBstocktransferThickness }} >
                                        <div className="col-md-4 print-label" dir="ltr" style={{ bstocktransferRight: detailsBstocktransferThickness, width: detailsLabelsColumnWidthPercent, padding: "3px" }} ><b>Vendor ID | معرف البائع:</b></div>
                                        <div className="col-md-8 print-value" dir="ltr" style={{ width: detailsValuesColumnWidthPercent, padding: "3px" }} >
                                    ...
                                    <div className="row" dir="ltr" style={{ bstocktransferBottom: detailsBstocktransferThickness }} >
                                        <div className="col-md-4 print-label" dir="ltr" style={{ bstocktransferRight: detailsBstocktransferThickness, width: detailsLabelsColumnWidthPercent, padding: "3px" }} ><b>Vendor VAT | ضريبة القيمة المضافة للعملاء:</b></div>
                                        <div className="col-md-8 print-value" dir="ltr" style={{ width: detailsValuesColumnWidthPercent, padding: "3px" }} >
                                    ...
                                    <div className="row" dir="ltr" style={{ bstocktransferBottom: detailsBstocktransferThickness }} >
                                        <div className="col-md-4 print-label" dir="ltr" style={{ bstocktransferRight: detailsBstocktransferThickness, width: detailsLabelsColumnWidthPercent, padding: "3px" }} ><b>Vendor C.R | رقم تسجيل الشركة الموردة:</b></div>
                                        <div className="col-md-8 print-value" dir="ltr" style={{ width: detailsValuesColumnWidthPercent, padding: "3px" }} >
                                    ...
                                    <div className="row" dir="ltr" style={{}} >
                                        <div className="col-md-4 print-label" dir="ltr" style={{ bstocktransferRight: detailsBstocktransferThickness, width: detailsLabelsColumnWidthPercent, padding: "3px" }} ><b>Vendor Address | عنوان العميل:</b> </div>
                                        <div className="col-md-8 print-value    " dir="ltr" style={{ width: detailsValuesColumnWidthPercent, padding: "3px" }} >
                            ...
                            {!props.model.store?.settings?.zatca_qr_on_left_bottom && props.modelName !== "delivery_note" && props.modelName !== "whatsapp_delivery_note" && props.modelName !== "quotation" && props.modelName !== "quotation_stocktransfers_return" && props.modelName !== "whatsapp_quotation" && props.modelName !== "whatsapp_quotation_stocktransfers_return" &&
                                <div
                                    className="col-md-2"
                                    style={{ bstocktransfer: "solid 0px", width: "26%" }}
                                    onClick={(e) => {
                                        e.preventDefault();
                                        e.stopPropagation();
                                ...
                                >
                                    {props.model.store?.zatca?.phase === "1" && props.model.QRImageData ? <img src={props.model.QRImageData} style={{ width: props.fontSizes[props.modelName + "_qrCode"]["width"]?.size, height: props.fontSizes[props.modelName + "_qrCode"]["height"]?.size, bstocktransfer: "solid 0px" }} alt="Invoice QR Code" /> : ""}
                                    ...
                                    /> : ""}
                                    {props.model.store?.zatca?.phase === "2" && !props.model.zatca?.qr_code ? <img src={props.model.QRImageData} style={{ width: props.fontSizes[props.modelName + "_qrCode"]["width"]?.size, height: props.fontSizes[props.modelName + "_qrCode"]["height"]?.size, bstocktransfer: "solid 0px" }} alt="Invoice QR Code" /> : ""}
                                </div>}
                        </div>
                            ...
                            <div className="col">
                                ...
                                >
                                    ...
                                    <table
                                        ...
                                        style={{ bstocktransfer: tableBstocktransferThickness, width: "100%" }}
                                    >
                                        <tbody style={{ fontSize: props.fontSizes[props.modelName + "_tableBody"]?.size }} className="clickable-text print-value" onClick={() => {
                                            ...
                                            <tr style={{ bstocktransferBottom: tableBstocktransferThickness, fontSize: props.fontSizes[props.modelName + "_tableHead"]?.size, height: "auto" }} onClick={(e) => {
                                                e.stopPropagation();
                                                props.selectText("tableHead");
                                            }}>
                                                <th className="per6 text-center" style={{ padding: "0px", width: "6%", bstocktransferRight: tableBstocktransferThickness, bstocktransferBottom: tableBstocktransferThickness }}>
                                                ...
                                                <th className="per14 text-center" style={{ padding: "0px", width: "14%", bstocktransferRight: tableBstocktransferThickness, bstocktransferBottom: tableBstocktransferThickness }}>
                                                    <ul
                                                        className="list-unstyled"
                                                        style={{
                                                            height: "auto",
                                                ...
                                                <th className="per33 text-center" style={{ padding: "0px", width: "31%", bstocktransferRight: tableBstocktransferThickness, bstocktransferBottom: tableBstocktransferThickness }}>
                                                    <ul
                                                        className="list-unstyled"
                                                        style={{
                                                            height: "auto",
                                                ...
                                                <th className="per5 text-center" style={{ padding: "0px", width: "5%", bstocktransferRight: tableBstocktransferThickness, bstocktransferBottom: tableBstocktransferThickness }}>
                                                    <ul
                                                        className="list-unstyled"
                                                        style={{
                                                            height: "auto",
                                                ...
                                                {props.modelName !== "delivery_note" && <>
                                                    <th className="per8 text-center" style={{ padding: "0px", width: "8%", bstocktransferRight: tableBstocktransferThickness, bstocktransferBottom: tableBstocktransferThickness }}>
                                                        <ul
                                                            className="list-unstyled"
                                                            style={{
                                                                height: "auto",
                                                    ...
                                                    <th className="per7 text-center" style={{ padding: "0px", width: "7%", bstocktransferRight: tableBstocktransferThickness, bstocktransferBottom: tableBstocktransferThickness }}>
                                                        <ul
                                                            className="list-unstyled"
                                                            style={{
                                                                height: "auto",
                                                    ...
                                                    <th className="per12 text-center" style={{ padding: "0px", width: "11%", bstocktransferRight: tableBstocktransferThickness, bstocktransferBottom: tableBstocktransferThickness }}>
                                                        {!props.model.hideVAT && <>
                                                            <ul
                                                                className="list-unstyled"
                                                                style={{
                                                    ...
                                                    {!props.model.hideVAT && <>
                                                        ...
                                                        <th className="per10 text-center" style={{ padding: "0px", width: "10%", bstocktransferBottom: tableBstocktransferThickness }}>
                                                            <ul
                                                                className="list-unstyled"
                                                                style={{
                                                                    height: "auto",
                                            ...
                                            {page.products && page.products.map((product, index) => (
                                                <tr style={{ bstocktransferBottom: tableBstocktransferThickness }} key={product.item_code} className="text-center"  >
                                                    <td style={{ padding: "7px", bstocktransferRight: tableBstocktransferThickness }}>{product.part_number ? index + 1 + (pageIndex * props.model.pageSize) : ""}</td>
                                                    <td style={{ bstocktransferRight: tableBstocktransferThickness }} >{product.prefix_part_number ? product.prefix_part_number + " - " : ""} {product.part_number ? product.part_number : ""}</td>
                                                    <th dir="ltr" style={{
                                                        unicodeBidi: 'isolate',
                                                        bstocktransferRight: tableBstocktransferThickness,
                                                        width: "31%",
                                                        maxWidth: "31%",
                                                    ...
                                                    <td style={{ bstocktransferRight: tableBstocktransferThickness, marginRight: "2px" }}>{product.quantity ? product.quantity : ""}  {product.unit ? product.unit : ""}</td>
                                                    {props.modelName !== "delivery_note" && <>
                                                        <td className="text-end" style={{ bstocktransferRight: tableBstocktransferThickness, paddingRight: "3px" }} >
                                                        ...
                                                        <td style={{ bstocktransferRight: tableBstocktransferThickness, paddingRight: "3px" }} className="text-end">
                                    ...
                                    {props.model.pages.length === (pageIndex + 1) && <table className="table-responsive"
                                        ...
                                        {props.modelName !== "delivery_note" && <tbody style={{ fontSize: props.fontSizes[props.modelName + "_tableFooter"]?.size }} onClick={() => {
                                            ...
                                            <tr style={{ bstocktransferBottom: tableBstocktransferThickness }}>
                                                {props.model.store?.settings?.zatca_qr_on_left_bottom && props.modelName !== "quotation" && props.modelName !== "whatsapp_quotation" && props.modelName !== "quotation_stocktransfers_return" && props.modelName !== "whatsapp_quotation_stocktransfers_return" && props.modelName !== "delivery_note" && <th rowSpan={7} style={{ width: "20%", padding: "3px", bstocktransferRight: tableBstocktransferThickness }}>
                                                    <div
                                                ...
                                                <th className="text-end print-label" style={{ padding: "2px", bstocktransferRight: tableBstocktransferThickness }}>
                                                    {!props.model.hideVAT && <>
                                            ...
                                            <tr style={{ bstocktransferBottom: tableBstocktransferThickness }}>
                                                <th className="text-end print-label" style={{ padding: "2px", width: `${props.modelName !== "quotation" ? "70%" : "90%"}`, bstocktransferRight: tableBstocktransferThickness }}>
                                    ...
                                    >
                                        {props.modelName !== "delivery_note" && <tbody style={{ fontSize: props.fontSizes[props.modelName + "_tableFooter"]?.size }} onClick={() => {
                                            ...
                                            <tr style={{ bstocktransferBottom: tableBstocktransferThickness }}>
                                                ...
                                                <th colSpan="2" className="text-end print-label" style={{ padding: "5px", width: "14.6%", bstocktransferRight: tableBstocktransferThickness }}>
                                                    In Words بكلمات:
                                                </th>
                                                <th
                                            ...
                                            <tr style={{ bstocktransferBottom: tableBstocktransferThickness }}>
                                                <th colSpan="2" className="text-end print-label" style={{ padding: "5px", bstocktransferRight: tableBstocktransferThickness }}>
                                                    Remarks ملاحظات:
                                                </th>
                                                <td
                                                    className="text-start print-value"
                                                    colSpan="7"
                                                    style={{ padding: "5px", bstocktransferRight: tableBstocktransferThickness }}
                                            ...
                                            {props.modelName === "quotation" && props.model.type === "quotation" && <>
                                                ...
                                                {props.model.pages.length === (pageIndex + 1) && props.model.store?.bank_account && props.model.store?.bank_account?.bank_name ? <tr >
                                                    <th colSpan="9" style={{ padding: "0px" }} onClick={(e) => e.stopPropagation()}>
                                                        ...
                                                        <table
                                                            className="table-responsive"
                                                            style={{ width: "100%", bstocktransfer: tableBstocktransferThickness }}
                                                        ...
                                                        >
                                                            ...
                                                            <tbody style={{ fontSize: props.fontSizes[props.modelName + "_bankAccountBody"]?.size }}
                                                                ...
                                                                <tr style={{ bstocktransferBottom: tableBstocktransferThickness, fontSize: props.fontSizes[props.modelName + "_bankAccountHeader"]?.size }} onClick={() => {
                                                                    props.selectText("bankAccountHeader");
                                                                }}>
                                                                ...
                                                                <tr style={{ bstocktransferBottom: tableBstocktransferThickness }}>
                                                                    <th className="per1 text-center print-label" style={{ padding: "0px", width: "5%", bstocktransferRight: tableBstocktransferThickness }}>
                                                                        <ul
                                                                            className="list-unstyled"
                                                                            style={{
                                                                                height: "auto"
                                                                    ...
                                                                    <th className="per1 text-center print-label" style={{ padding: "0px", maxWidth: "100px", bstocktransferRight: tableBstocktransferThickness }}>
                                                                        <ul
                                                                            className="list-unstyled"
                                                                            style={{
                                                                                height: "auto"
                                                                    ...
                                                                    <th className="per1 text-center print-label" style={{ padding: "0px", width: "10%", bstocktransferRight: tableBstocktransferThickness }}>
                                                                        <ul
                                                                            className="list-unstyled"
                                                                            style={{
                                                                                height: "auto"
                                                                ...
                                                                <tr >
                                                                    <td style={{ width: "25%", bstocktransferRight: tableBstocktransferThickness, padding: "10px" }}>

                                                                        {props.model.store?.bank_account?.bank_name}
                                                                    </td>
                                                                    <td style={{ width: "15%", bstocktransferRight: tableBstocktransferThickness, padding: "10px" }}>

                                                                        {props.model.store?.bank_account?.customer_no}
                                                                    </td>
                                                                    <td style={{ maxWidth: "25%", bstocktransferRight: tableBstocktransferThickness, padding: "10px" }}>
                                                                        {props.model.store?.bank_account?.iban}
                                                                    </td>
                                                                    <td style={{ width: "20%", bstocktransferRight: tableBstocktransferThickness, padding: "10px" }}>
