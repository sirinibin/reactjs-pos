...
const StockTransferPrintContent = forwardRef((props, ref) => {
    //Non-A4
    ...
    return (<>
        <span ref={ref}>
            {props.model.pages && props.model.pages.map((page, pageIndex) => (
                ...
                >
                    <h2 style={{ fontSize: "4mm", position: "absolute", left: "305px", top: (40 + page.top) + "px", bstocktransfer: "solid " + bstocktransfer + "px", textDecoration: "underline", }}>
                        {props.model.invoiceTitle}
                    </h2>

                    <h4 style={{ fontSize: "3mm", position: "absolute", left: "100px", top: (14 + page.top) + "px", bstocktransfer: "solid " + bstocktransfer + "px", }}>
                    ...
                    <h4 style={{ fontSize: "3mm", position: "absolute", left: "570px", top: (14 + page.top) + "px", bstocktransfer: "solid " + bstocktransfer + "px", }}>
                    ...
                    <h4 style={{ fontSize: "3mm", position: "absolute", left: "570px", top: (35 + page.top) + "px", bstocktransfer: "solid " + bstocktransfer + "px", }}>
                    ...
                    <table style={{ fontSize: "3mm", position: "absolute", left: "18px", top: (119 + page.top) + "px", bstocktransfer: "solid 0px", }}>
                        <tbody>
                            {page.products && page.products.map((product, index) => (
                                <tr key={product.item_code} style={{ paddingTop: "1px", height: "8px", bstocktransferBottom: "solid 1px" }}>
                                    <td className="text-center" style={{ bstocktransfer: "solid 0px", width: "48px", }}>
                                        <h4 style={{ fontSize: "3mm" }}>{index + 1 + (pageIndex * props.model.pageSize)}
                                        </h4>
                                    </td>
                                    <td className="text-center" style={{ bstocktransfer: "solid 0px", width: "93px" }} >
                                        <h4 style={{ fontSize: "2.2mm" }}>
                                            {product.prefix_part_number ? product.prefix_part_number + " - " : ""}{product.part_number ? product.part_number : ""}
                                        </h4>
                                    </td>
                                    <td className="text-left" style={{ bstocktransfer: "solid 0px", width: "299px", paddingLeft: "5px" }} >
                                    ...
                                    <td className="text-end" style={{ bstocktransfer: "solid 0px", width: "111px", paddingRight: "5px" }}>
                                    ...
                                    <td className="text-end" style={{ bstocktransfer: "solid 0px", width: "99px", paddingRight: "5px" }} >
                                        <h4 style={{ fontSize: "3mm" }}>
                                            <NumberFormat
                    ...
                    {page.lastPage ? <table style={{ fontSize: "3mm", position: "absolute", left: "646px", top: (530 + page.top) + "px", bstocktransfer: "solid 0px", }}>
                        <tbody>
                    ...
                    {page.lastPage && props.model.net_total ? <h4 style={{ fontSize: "3mm", position: "absolute", right: "320px", top: (565 + page.top) + "px" }}>
                        {n2words(props.model.net_total, { lang: 'ar' }) + " ريال سعودي  "}
                    </h4> : ""}
                    {page.lastPage && props.model.net_total ? <h4 style={{ fontSize: "3mm", position: "absolute", left: "50px", top: (580 + page.top) + "px" }}>
                    ...
                    {page.lastPage && props.model?.modelName !== "quotation" && props.model?.modelName !== "quotation_stocktransfers_return" && props.model?.modelName !== "delivery_note" ? <div style={{ position: "absolute", left: "600px", top: (670 + page.top) + "px" }} >
...
export default StockTransferPrintContent;