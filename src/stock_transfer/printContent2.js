...
const StockTransferPrintContent2 = forwardRef((props, ref) => {
    //Non-A4
    ...
    return (<>
        <span ref={ref}>
            {props.model.pages && props.model.pages.map((page, pageIndex) => (
                ...
                >
                    <h2 className="print-value" style={{ textAlign: "center", minWidth: "350px", fontSize: "4mm", position: "absolute", left: "300px", top: (179 + page.top) + "px", bstocktransfer: "solid " + bstocktransfer + "px", textDecoration: "underline", }}>
                        {/*"TAX INVOICE / فاتورة ضريبية"*/}
                        {props.model.invoiceTitle}
                    </h2>

                    <h4 className="print-value" style={{ fontSize: "3mm", position: "absolute", left: "395px", top: (208 + page.top) + "px", bstocktransfer: "solid " + bstocktransfer + "px", }}>
                        {props.model.code ? props.model.code : ""}
                    </h4>

                    <h4 className="print-value text-center" style={{ fontSize: "3.5mm", maxWidth: "450px", minWidth: "450px", position: "absolute", left: "350px", top: (234 + page.top) + "px", bstocktransfer: "solid " + bstocktransfer + "px", }}>
                    ...
                    <h4 className="print-value" style={{ fontSize: "3.5mm", position: "absolute", left: "600px", top: (198 + page.top) + "px", bstocktransfer: "solid " + bstocktransfer + "px", }}>
                    ...
                    <table className="print-value" style={{ fontSize: "3mm", position: "absolute", left: "90px", top: (340 + page.top) + "px", bstocktransfer: "solid 0px", }}>
                        <tbody>
                            {page.products && page.products.map((product, index) => (
                                <tr key={product.item_code} style={{ paddingTop: "1px", height: "6px", bstocktransferBottom: "solid 1px" }}>
                                    ...
                                    <td className="text-left" style={{ bstocktransfer: "solid 0px", width: "120px", height: "auto", }} >
                                    ...
                                    <td className="text-left" style={{ bstocktransfer: "solid 0px", width: "350px", paddingLeft: "10px" }} >
                                        {props.model?.store?.settings?.one_line_product_name_in_print_invoice && <div
                                            style={{ //one_line_product_name_in_invoice
                                                display: 'inline-block',
                                                maxWidth: `350px`,
                                    ...
                                    <td className="text-center" style={{ bstocktransfer: "solid 0px", width: "65px", }}>
                                    ...
                                    <td className="text-end" style={{ bstocktransfer: "solid 0px", width: "92px", paddingRight: "5px" }} >
                    ...
                    {page.lastPage ? <table className="print-value" style={{ minWidth: "150px", fontSize: "3mm", position: "absolute", left: "678px", top: (745 + page.top) + "px", bstocktransfer: "solid 0px", }}>
                        <tbody>
                    ...
                    {page.lastPage && props.model?.modelName !== "quotation" && props.model?.modelName !== "quotation_stocktransfers_return" && props.model?.modelName !== "delivery_note" ? <div className="print-value" style={{ position: "absolute", left: "95px", top: (640 + page.top) + "px" }} >
                        ...
                        {props.model.store?.zatca?.phase === "1" && props.model.QRImageData ? <img src={props.model.QRImageData} style={{ width: "100px", height: "100px", bstocktransfer: "solid 0px" }} alt="Invoice QR Code" /> : ""}
                        ...
                        /> : ""}
                        {props.model.store?.zatca?.phase === "2" && !props.model.zatca?.qr_code ? <img src={props.model.QRImageData} style={{ width: "100px", height: "100px", bstocktransfer: "solid 0px" }} alt="Invoice QR Code" /> : ""}

                    </div> : ""}

                    <h4 className="print-value" style={{ fontSize: "2.8mm", position: "absolute", left: "162px", top: (760 + page.top) + "px", bstocktransfer: "solid " + bstocktransfer + "px", }}>
                        {props.model.remarks ? props.model.remarks : "N/A"}
                    </h4>


                    <h4 className="print-value" style={{ fontSize: "4.7mm", position: "absolute", left: "200px", top: (813 + page.top) + "px", bstocktransfer: "solid " + bstocktransfer + "px", }}>
                        {props.model.customer && props.model.customer.vat_no ? props.model.customer.vat_no : "N/A"}
                    </h4>
                </div>
...
export default StockTransferPrintContent2;