...
const StockTransferPrintContent3 = forwardRef((props, ref) => {
    //Non-A4
    ...
    return (<>
        <span ref={ref}>
            {props.model.pages && props.model.pages.map((page, pageIndex) => (
                ...
                >
                    <h2 className="print-value" style={{ textAlign: "center", minWidth: "350px", fontSize: "4mm", position: "absolute", left: "215px", top: (100 + page.top) + "px", bstocktransfer: "solid " + bstocktransfer + "px", textDecoration: "underline", }}>
                        {/*"TAX INVOICE / فاتورة ضريبية"*/}
                        {props.model.invoiceTitle}
                    </h2>

                    <h4 className="print-value text-center" style={{ textAlign: "center", fontSize: "3mm", position: "absolute", left: "320px", top: (130 + page.top) + "px", bstocktransfer: "solid " + bstocktransfer + "px", }}>
                        {props.model.code ? props.model.code : ""}
                    </h4>

                    <h4 className="print-value text-center" style={{ textAlign: "center", fontSize: "3mm", position: "absolute", left: "20px", top: (125 + page.top) + "px", bstocktransfer: "solid " + bstocktransfer + "px", }}>
                        {props.model.store ? props.model.store.branch_name : ""}
                    </h4>
                    <h4 className="print-value" style={{ fontSize: "3.5mm", maxWidth: "450px", minWidth: "450px", position: "absolute", left: "20px", top: (150 + page.top) + "px", bstocktransfer: "solid " + bstocktransfer + "px", }}>
                        {props.model.customer && props.model.customer.code ? props.model.customer.code : ""}
                    </h4>


                    <h4 className="print-value" style={{ fontSize: "3.5mm", maxWidth: "450px", minWidth: "450px", position: "absolute", left: "175px", top: (150 + page.top) + "px", bstocktransfer: "solid " + bstocktransfer + "px", }}>
                        {props.model.customer && props.model.customer.name ? props.model.customer.name : ""}
                    </h4>

                    <h4 className="print-value" dir="rtl" style={{ fontSize: "3.5mm", maxWidth: "450px", minWidth: "450px", position: "absolute", right: "170px", top: (165 + page.top) + "px", bstocktransfer: "solid " + bstocktransfer + "px", }}>
                        {props.model.customer && props.model.customer.name_in_arabic ? props.model.customer.name_in_arabic : ""}
                    </h4>


                    <h4 className="print-value" style={{ fontSize: "3.5mm", position: "absolute", left: "550px", top: (122 + page.top) + "px", bstocktransfer: "solid " + bstocktransfer + "px", }}>
                    ...
                    < table className="print-value" style={{ fontSize: "3mm", position: "absolute", left: "10px", top: (250 + page.top) + "px", bstocktransfer: "solid 0px", }}>
                        <tbody>
                            {page.products && page.products.map((product, index) => (
                                <tr key={product.item_code} style={{ paddingTop: "1px", height: "6px", bstocktransferBottom: "solid 1px" }}>
                                    <td className="text-center " style={{ bstocktransfer: "solid 0px", width: "35px", }}>
                                        <h4 className="print-value" style={{ fontSize: "3mm", maxWidth: "35px" }}>
                                            {index + 1 + (pageIndex * props.model.pageSize)}
                                        </h4>
                                    </td>
                                    <td className="text-left" style={{ bstocktransfer: "solid 0px", width: "125px", height: "auto", }} >
                                        ...
                                        >
                                            <h4 className="print-value-new" style={{ fontSize: "3mm", maxWidth: "125px", height: "auto", }}>
                                    ...
                                    <td className="text-left" style={{ bstocktransfer: "solid 0px", width: "365px", paddingLeft: "15px" }} >
                                        {props.model?.store?.settings?.one_line_product_name_in_print_invoice && <div
                                            style={{ //one_line_product_name_in_invoice
                                                display: 'inline-block',
                                                maxWidth: `365px`,
                                        ...
                                        >
                                            ...
                                            {product.name && !product.name_in_arabic ? <h4 className="print-value-new" style={{ fontSize: "3mm", position: "relative", top: "2px", bstocktransfer: "solid 0px" }}>
                                                {product.name}
                                            </h4> : ""}
                                    ...
                                    <td className="text-center" style={{ bstocktransfer: "solid 0px", width: "70px", }}>
                                        <h4 className="print-value" style={{ fontSize: "3mm", maxWidth: "70px" }}>
                                            {product.quantity}  {product.unit ? product.unit : ""}
                                        </h4>
                                    </td>
                                    <td className="text-end" style={{ bstocktransfer: "solid 0px", width: "75px", paddingRight: "5px" }}>
                                    ...
                                    <td className="text-end" style={{ bstocktransfer: "solid 0px", width: "96px", paddingRight: "5px" }} >
                                        <h4 className="print-value" style={{ fontSize: "3mm", maxWidth: "96px" }}>
                                            <NumberFormat
                    ...
                    {page.lastPage ? <table className="print-value" style={{ minWidth: "150px", fontSize: "3mm", position: "absolute", left: "620px", top: (820 + page.top) + "px", bstocktransfer: "solid 0px", }}>
                        <tbody>
                    ...
                    {page.lastPage && props.model?.modelName !== "quotation" && props.model?.modelName !== "quotation_stocktransfers_return" && props.model?.modelName !== "delivery_note" ? <div className="print-value" style={{ position: "absolute", left: "10px", top: (680 + page.top) + "px" }} >
                        ...
                        {props.model.store?.zatca?.phase === "1" && props.model.QRImageData ? <img src={props.model.QRImageData} style={{ width: "150px", height: "150px", bstocktransfer: "solid 0px" }} alt="Invoice QR Code" /> : ""}
                    ...
                    <h4 className="print-value" style={{ fontSize: "2.8mm", position: "absolute", left: "85px", top: (963 + page.top) + "px", bstocktransfer: "solid " + bstocktransfer + "px", }}>
                        {props.model.remarks ? props.model.remarks : "N/A"}
                    </h4>


                    <h4 className="print-value" style={{ fontSize: "4.7mm", position: "absolute", left: "110px", top: (880 + page.top) + "px", bstocktransfer: "solid " + bstocktransfer + "px", }}>
                        {props.model.customer && props.model.customer.vat_no ? props.model.customer.vat_no : "N/A"}
                    </h4>
                </div >
...
export default StockTransferPrintContent3;