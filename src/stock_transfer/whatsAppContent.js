        ...
        <span ref={ref}>
            {props.model.pages && props.model.pages.map((page, pageIndex) => (
                ...
                >
                    ...
                    <div className="row col-md-14 fw-bold" style={{ bstocktransfer: "solid 0px", fontSize: props.fontSizes[props.modelName + "_invoiceDetails"]?.size, padding: "10px" }} onClick={() => {
                        props.selectText("invoiceDetails");
                    }}>
                        <div className="col-md-12" style={{ bstocktransfer: "solid 1px", marginLeft: "0px", width: `${props.model.store?.settings?.zatca_qr_on_left_bottom ? "100%" : "74%"}` }}>
                            {props.model.invoice_count_value && props.model.store?.zatca?.phase === "2" ? <div className="row" dir="ltr" style={{ bstocktransfer: "solid 0px" }} >
                                <div className="col-md-4" dir="ltr" style={{ bstocktransfer: "solid 1px", width: "35%", padding: "3px" }} >Invoice Count Value | عد الفاتورة (ICV):</div>
                                <div className="col-md-8" dir="ltr" style={{ bstocktransfer: "solid 1px", width: "65%", padding: "3px" }} >  {props.model.invoice_count_value ? props.model.invoice_count_value : ""}</div>
                            </div> : ""}
                            {props.model.uuid && props.model.store?.zatca?.phase === "2" ? <div className="row" dir="ltr" style={{ bstocktransfer: "solid 0px" }} >
                                <div className="col-md-4" dir="ltr" style={{ bstocktransfer: "solid 1px", width: "35%", padding: "3px" }} >UUID:</div>
                                <div className="col-md-8" dir="ltr" style={{ bstocktransfer: "solid 1px", width: "65%", padding: "3px" }} > {props.model.uuid ? props.model.uuid : ""}</div>
                            </div> : ""}
                            <div className="row" dir="ltr" style={{ bstocktransfer: "solid 0px" }} >
                                <div className="col-md-4" dir="ltr" style={{ bstocktransfer: "solid 1px", width: "35%", padding: "3px" }} >Invoice No. | رقم الفاتورة:</div>
                                <div className="col-md-8" dir="ltr" style={{ bstocktransfer: "solid 1px", width: "65%", padding: "3px" }} >    {props.model.code ? props.model.code : ""}</div>
                            </div>
                            <div className="row" dir="ltr" style={{ bstocktransfer: "solid 0px" }} >
                                <div className="col-md-4" dir="ltr" style={{ bstocktransfer: "solid 1px", width: "35%", padding: "3px" }} > Invoice Date | تاريخ الفاتورة:</div>
                                <div className="col-md-8" dir="ltr" style={{ bstocktransfer: "solid 1px", width: "65%", padding: "3px" }} > {props.model.date ? format(
                                    new Date(props.model.date),
                                    "yyyy-MM-dd h:mma"
                                ) : "<DATETIME>"} {" | " + getArabicDate(props.model.date)}</div>
                            </div>
                            {props.model && props.model.stocktransfer_code && props.modelName === "stocktransfer_return" && <div className="row" dir="ltr" style={{ bstocktransfer: "solid 0px" }} >
                                <div className="col-md-4" dir="ltr" style={{ bstocktransfer: "solid 1px", width: "35%", padding: "3px" }} >Original Invoice No. | رقم الفاتورة الأصلية:</div>
                                <div className="col-md-8" dir="ltr" style={{ bstocktransfer: "solid 1px", width: "65%", padding: "3px" }} >    {props.model.stocktransfer_code ? props.model.stocktransfer_code : ""}</div>
                            </div>}
                            {props.model && props.model.stocktransfer_code && props.model.stocktransfer?.date && props.modelName === "stocktransfer_return" && <div className="row" dir="ltr" style={{ bstocktransfer: "solid 0px" }} >
                                <div className="col-md-4" dir="ltr" style={{ bstocktransfer: "solid 1px", width: "35%", padding: "3px" }} > Original Invoice Date | تاريخ الفاتورة الأصلية:</div>
                                <div className="col-md-8" dir="ltr" style={{ bstocktransfer: "solid 1px", width: "65%", padding: "3px" }} > {props.model.stocktransfer?.date ? format(
                                    new Date(props.model.stocktransfer?.date),
                                    "yyyy-MM-dd h:mma"
                                ) : "<DATETIME>"} {" | " + getArabicDate(props.model.stocktransfer?.date)}</div>
                            </div>}
                            {props.model && props.model.purchase_code && props.modelName === "purchase_return" && <div className="row" dir="ltr" style={{ bstocktransfer: "solid 0px" }} >
                                <div className="col-md-4" dir="ltr" style={{ bstocktransfer: "solid 1px", width: "35%", padding: "3px" }} >Original Invoice No. | رقم الفاتورة الأصلية:</div>
                                <div className="col-md-8" dir="ltr" style={{ bstocktransfer: "solid 1px", width: "65%", padding: "3px" }} >    {props.model.purchase_code ? props.model.purchase_code : ""}</div>
                            </div>}
                            {props.model && props.model.purchase_code && props.model.purchase?.date && props.modelName === "purchase_return" && <div className="row" dir="ltr" style={{ bstocktransfer: "solid 0px" }} >
                                <div className="col-md-4" dir="ltr" style={{ bstocktransfer: "solid 1px", width: "35%", padding: "3px" }} > Original Invoice Date | تاريخ الفاتورة الأصلية:</div>
                                <div className="col-md-8" dir="ltr" style={{ bstocktransfer: "solid 1px", width: "65%", padding: "3px" }} > {props.model.purchase?.date ? format(
                                    new Date(props.model.purchase?.date),
                                    "yyyy-MM-dd h:mma"
                                ) : "<DATETIME>"} {" | " + getArabicDate(props.model.purchase?.date)}</div>
                            </div>}

                            {props.modelName === "stocktransfer" || props.modelName === "stocktransfer_return" || props.modelName === "quotation" || props.modelName === "delivery_note" ? <>
                                <div className="row" dir="ltr" style={{ bstocktransfer: "solid 0px" }} >
                                    <div className="col-md-4" dir="ltr" style={{ bstocktransfer: "solid 1px", width: "35%", padding: "3px" }} >  Customer Name | اسم العميل:</div>
                                    <div className="col-md-8" dir="ltr" style={{ bstocktransfer: "solid 1px", width: "65%", padding: "3px" }} >
                                ...
                                <div className="row" dir="ltr" style={{ bstocktransfer: "solid 0px" }} >
                                    <div className="col-md-4" dir="ltr" style={{ bstocktransfer: "solid 1px", width: "35%", padding: "3px" }} >   Customer VAT  | ضريبة القيمة المضافة للعملاء:</div>
                                    <div className="col-md-8" dir="ltr" style={{ bstocktransfer: "solid 1px", width: "65%", padding: "3px" }} >
                                ...
                                <div className="row" dir="ltr" style={{ bstocktransfer: "solid 0px" }} >
                                    <div className="col-md-4" dir="ltr" style={{ bstocktransfer: "solid 1px", width: "35%", padding: "3px" }} > Customer C.R | رقم تسجيل شركة العميل:</div>
                                    <div className="col-md-8" dir="ltr" style={{ bstocktransfer: "solid 1px", width: "65%", padding: "3px" }} >
                                ...
                                <div className="row" dir="ltr" style={{ bstocktransfer: "solid 0px" }} >
                                    <div className="col-md-4" dir="ltr" style={{ bstocktransfer: "solid 1px", width: "35%", padding: "3px" }} > Customer Address | عنوان العميل:</div>
                                    <div className="col-md-8" dir="ltr" style={{ bstocktransfer: "solid 1px", width: "65%", padding: "3px" }} >
                            ...
                            {props.modelName === "purchase" || props.modelName === "purchase_return" ? <>
                                <div className="row" dir="ltr" style={{ bstocktransfer: "solid 0px" }} >
                                    <div className="col-md-4" dir="ltr" style={{ bstocktransfer: "solid 1px", width: "35%", padding: "3px" }} >  Vendor Name | اسم العميل:</div>
                                    <div className="col-md-8" dir="ltr" style={{ bstocktransfer: "solid 1px", width: "65%", padding: "3px" }} >
                                ...
                                <div className="row" dir="ltr" style={{ bstocktransfer: "solid 0px" }} >
                                    <div className="col-md-4" dir="ltr" style={{ bstocktransfer: "solid 1px", width: "35%", padding: "3px" }} >  Vendor VAT | ضريبة القيمة المضافة للعملاء:</div>
                                    <div className="col-md-8" dir="ltr" style={{ bstocktransfer: "solid 1px", width: "65%", padding: "3px" }} >
                                ...
                                <div className="row" dir="ltr" style={{ bstocktransfer: "solid 0px" }} >
                                    <div className="col-md-4" dir="ltr" style={{ bstocktransfer: "solid 1px", width: "35%", padding: "3px" }} > Vendor C.R | رقم تسجيل الشركة الموردة:</div>
                                    <div className="col-md-8" dir="ltr" style={{ bstocktransfer: "solid 1px", width: "65%", padding: "3px" }} >
                                ...
                                <div className="row" dir="ltr" style={{ bstocktransfer: "solid 0px" }} >
                                    <div className="col-md-4" dir="ltr" style={{ bstocktransfer: "solid 1px", width: "35%", padding: "3px" }} > Vendor Address | عنوان العميل:</div>
                                    <div className="col-md-8" dir="ltr" style={{ bstocktransfer: "solid 1px", width: "65%", padding: "3px" }} >
                        ...
                        {!props.model.store?.settings?.zatca_qr_on_left_bottom && props.modelName !== "quotation" && props.modelName !== "delivery_note" && <div className="col-md-2" style={{ bstocktransfer: "solid 0px", width: "26%" }}>
                            {props.model.store?.zatca?.phase === "1" && props.model.QRImageData ? <img src={props.model.QRImageData} style={{ width: "138px", height: "138px", bstocktransfer: "solid 0px" }} alt="Invoice QR Code" /> : ""}
                    ...
                    <div className="row">
                        <div className="col">
                            ...
                            >
                                ...
                                <table
                                    className="table no-bold table-bstocktransfered no-bold"
                                    style={{ bstocktransferRadius: "6px" }}
                                >
                                    ...
                                    {props.modelName !== "delivery_note" && <tfoot style={{ fontSize: props.fontSizes[props.modelName + "_tableFooter"]?.size }} onClick={() => {
                                        ...
                                        <tr >
                                            {props.model.store?.settings?.zatca_qr_on_left_bottom && props.modelName !== "quotation" && props.modelName !== "delivery_note" && <th colSpan={2} rowSpan={6} style={{ maxWidth: "138px", maxHeight: "138px", }}>
                                                <div className="col-md-1 text-center" style={{ bstocktransfer: "solid 0px", padding: "0px", maxWidth: "138px", maxHeight: "138px", marginLeft: "-7px", marginTop: "-7px" }}>
                                                    ...
                                                    {props.model.store?.zatca?.phase === "2" && props.model.zatca?.qr_code ? <QRCodeCanvas value={props.model.zatca?.qr_code} style={{ width: "138px", height: "138px", bstocktransfer: "solid 0px", }} size={138} /> : ""}
                                                </div>
                                            </th>}
                                        ...
                                        {props.modelName === "quotation" && <>
                                            ...
                                            {props.model.pages.length === (pageIndex + 1) && props.model.store?.bank_account && props.model.store?.bank_account?.bank_name ? <tr >
                                                <td colSpan="9" style={{ padding: "0px" }} onClick={(e) => e.stopPropagation()}>
                                                    ...
                                                    <table
                                                        className="table table-bstocktransfered fw-bold no-bold"
                                                        style={{ bstocktransferRadius: "6px" }}
                                ...
                                <table className="table table-bstocktransfered fw-bold clickable-text" style={{ fontSize: props.fontSizes[props.modelName + "_signature"]?.size }} onClick={() => {
