    ...
    render() {
        return <>
            ...
            <Modal show={this.state.show} size="lg" onHide={this.handleClose} animation={false}>
                <Modal.Header>
                    <Modal.Title>Store #123 Details</Modal.Title>
                ...
                <Modal.Body>
                    <Table striped bordered hover responsive="lg">
                        <tr>
                            ...
                            <th>Store Name:</th><td> Store1</td>
                        </tr>
                        <tr>
                            <th>Store Name(in Arabic):</th><td> Store1</td>
                            <th>Store Title:</th><td> Title here</td>

                        </tr>
                        <tr>
                            <th>Store Title(in Arabic):</th><td> Title in Arabic</td>
