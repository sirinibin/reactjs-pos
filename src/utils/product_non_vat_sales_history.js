...
const ProductNonVATSalesHistory = forwardRef((props, ref) => {
    ...
    async function loadHistory(model) {
        ...
        try {
            const params = new URLSearchParams({
                ...
                limit: 50,
                sort: "-created_at",
                select: "id,non_vat_sales_code,date,customer_name,quantity,unit_price,unit_price_with_vat,price,net_price",
            });
            const r = await fetch(`/v1/non-vat-sales/history?${params}`, {
                ...
                <div style={{ padding: "12px", overflowX: "auto" }}>
                    {isLoading ? (
                        ...
                        <div style={{ textAlign: "center", padding: "32px", color: "#6b7280" }}>
                            ...
                            No non-VAT sales history found.
                        </div>
                    ) : (
                            ...
                            <tbody>
                                {historyList.map((row, i) => (
                                    <tr key={row.id || i}>
                                        ...
                                        <td style={{ padding: "6px 10px", fontWeight: 600 }}>{row.non_vat_sales_code || "—"}</td>
...
export default ProductNonVATSalesHistory;
