...
const ProductQuotationSalesReturnHistory = forwardRef((props, ref) => {
    ...
    const ProductQuotationSalesReturnHistoryTableRef = useRef();
        ...
        <>
            ...
            >
                <Modal.Header>
                    <Modal.Title>
                        <Modal.Title>
                            Qtn. Sales Return History of {product.name} {product.name_in_arabic ? " / " + product.name_in_arabic : ""}
                ...
                <Modal.Body>
                    <>
                        {show && <ProductQuotationSalesReturnHistoryTable
                            ref={ProductQuotationSalesReturnHistoryTableRef}
                            model={product}
