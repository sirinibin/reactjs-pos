...
const Sales = forwardRef((props, ref) => {
    ...
    return (
        <>
            <Modal
                show={show}
                size="xl"                        // ✅ Use Bootstrap's xl size
                onHide={handleClose}
                animation={false}
                scrollable={true}
            ...
            >
                <Modal.Header >
                    <Modal.Title>Select Sales</Modal.Title>
