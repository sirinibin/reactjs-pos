...
jest.mock('../../utils/ImageGallery.js', () => {
    ...
    return forwardRef((props, ref) => {
        useImperativeHandle(ref, () => ({
            open: jest.fn(),
            uploadAllImages: jest.fn().mockResolvedValue(undefined),
        }));
        return null;
    });
});
...
// ── Smoke tests ────────────────────────────────────────────────────────────
describe('VendorCreate smoke tests', () => {
    ...
    it('renders without crashing with optional props', () => {
        ...
        const handleVendorCreateFormClose = jest.fn();
        const ref = React.createRef();
        const { container } = render(
            <MemoryRouter>
                <VendorCreate
                    ...
                    handleVendorCreateFormClose={handleVendorCreateFormClose}
                />
            </MemoryRouter>
        );
        expect(container).toBeTruthy();
